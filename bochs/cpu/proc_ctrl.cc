...
enum {
  BX_POLY_MODE_X86 = 0,
  BX_POLY_MODE_RAW_AARCH64 = 1,
  BX_POLY_MODE_RAW_RISCV = 2
};
...
static const Bit32u BX_POLY_AARCH64_CTRL_SUBOP_CALL_SIG_IMM_BASE = 0x50;
...
static const Bit32u BX_POLY_CPUID_FEATURE_PER_THREAD_STATE = (1U << 10);
...
static const Bit32u BX_POLY_CPUID_FEATURE_AARCH64_HFA32_ARGS = (1U << 21);
static const Bit32u BX_POLY_CPUID_FEATURE_RESERVED_IMPORT_SELECTOR_TRAPS = (1U << 22);
static const Bit32u BX_POLY_CPUID_FEATURE_HARDWARE_FP64_STACK_ARGS = (1U << 23);
static const Bit32u BX_POLY_CPUID_FEATURE_HARDWARE_NEUTRAL_FP64_STACK = (1U << 24);
...
static const Bit32u BX_POLY_CPUID_FEATURE_LEGACY_AARCH64_HFA_ARGS = (1U << 30);
...
static const Bit32u BX_POLY_STATE_XSAVE_FLAG_COMPLETE_BANK_EXPORT = (1U << 4);
...
static const Bit64u BX_POLY_TRAP_RESTORE_FLAG_RISCV_STATE_VALID = (1ULL << 2);
static const Bit64u BX_POLY_TRAP_RESTORE_FLAGS_SUPPORTED =
  BX_POLY_TRAP_RESTORE_FLAG_VALID |
  BX_POLY_TRAP_RESTORE_FLAG_AARCH64_STATE_VALID |
...
static const Bit32u BX_POLY_STATE_XSAVE_AARCH64_GPR_BYTES = 0x100;
static const Bit32u BX_POLY_STATE_XSAVE_AARCH64_FP_OFFSET = 0x200;
static const Bit32u BX_POLY_STATE_XSAVE_AARCH64_FP_BYTES = 0x200;
static const Bit32u BX_POLY_STATE_XSAVE_AARCH64_STATUS_OFFSET = 0x400;
static const Bit32u BX_POLY_STATE_XSAVE_AARCH64_STATUS_BYTES = 0x80;
static const Bit32u BX_POLY_STATE_XSAVE_RISCV_GPR_OFFSET = 0x480;
static const Bit32u BX_POLY_STATE_XSAVE_RISCV_GPR_BYTES = 0x100;
static const Bit32u BX_POLY_STATE_XSAVE_RISCV_FP_OFFSET = 0x580;
static const Bit32u BX_POLY_STATE_XSAVE_RISCV_FP_BYTES = 0x200;
...
static const Bit32u BX_POLY_STATE_XSAVE_TRAP_RESTORE_OFFSET = 0x1000;
static const Bit32u BX_POLY_STATE_XSAVE_TRAP_RESTORE_BYTES = 0x800;
static const Bit32u BX_POLY_STATE_XSAVE_TRAP_RESTORE_FLAGS_OFFSET = 0x000;
static const Bit32u BX_POLY_STATE_XSAVE_TRAP_RESTORE_MODE_OFFSET = 0x008;
static const Bit32u BX_POLY_STATE_XSAVE_TRAP_RESTORE_X86_GPR_OFFSET = 0x010;
static const Bit32u BX_POLY_STATE_XSAVE_TRAP_RESTORE_X86_XMM_OFFSET = 0x090;
static const Bit32u BX_POLY_STATE_XSAVE_TRAP_RESTORE_AARCH64_VALID_OFFSET = 0x190;
static const Bit32u BX_POLY_STATE_XSAVE_TRAP_RESTORE_AARCH64_GPR_OFFSET = 0x198;
static const Bit32u BX_POLY_STATE_XSAVE_TRAP_RESTORE_AARCH64_FP_OFFSET = 0x298;
static const Bit32u BX_POLY_STATE_XSAVE_TRAP_RESTORE_AARCH64_STATUS_OFFSET = 0x498;
static const Bit32u BX_POLY_STATE_XSAVE_TRAP_RESTORE_RISCV_VALID_OFFSET = 0x4b8;
static const Bit32u BX_POLY_STATE_XSAVE_TRAP_RESTORE_RISCV_GPR_OFFSET = 0x4c0;
static const Bit32u BX_POLY_STATE_XSAVE_TRAP_RESTORE_RISCV_FP_OFFSET = 0x5c0;
...
static const Bit32u BX_POLY_TRANSITION_FLAG_NATIVE_FRONTEND_WIDTHS = (1U << 5);
...
static const Bit32u BX_POLY_TRANSITION_FLAGS_SUPPORTED =
  ...
  BX_POLY_TRANSITION_FLAG_NATIVE_FRONTEND_WIDTHS |
...
static const Bit32u BX_POLY_ABI_BRIDGE_FLAG_REGISTER_ONLY_AGGREGATES = (1U << 4);
static const Bit32u BX_POLY_ABI_BRIDGE_FLAG_HARDWARE_STACK_ARGS = (1U << 5);
static const Bit32u BX_POLY_ABI_BRIDGE_FLAG_HARDWARE_IMPORT_DESCRIPTORS = (1U << 6);
static const Bit32u BX_POLY_ABI_BRIDGE_FLAG_TLS_BASE = (1U << 7);
static const Bit32u BX_POLY_ABI_BRIDGE_FLAG_HARDWARE_USER_DESCRIPTORS = (1U << 8);
...
static const Bit32u BX_POLY_ABI_BRIDGE_FLAG_REGISTER_MAP_SIGNATURES = (1U << 14);
...
static const Bit32u BX_POLY_ABI_SIGNATURE_KIND_SRET_X86_SYSV_REGS = 11;
static const Bit32u BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_FP128_RET = 12;
static const Bit32u BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_FPAIR32_RET = 13;
static const Bit32u BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_FPAIR32_ARG = 14;
static const Bit32u BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_HETERO_U64_F64 = 15;
static const Bit32u BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_HETERO_F64_U64 = 16;
static const Bit32u BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_HETERO_U64_F32 = 17;
...
static const Bit32u BX_POLY_ABI_REGISTER_MAP_SRET_X86_SYSV_TO_NATIVE = 10;
static const Bit32u BX_POLY_ABI_REGISTER_MAP_X86_SYSV_TO_NATIVE_FP128_RET = 11;
static const Bit32u BX_POLY_ABI_REGISTER_MAP_X86_SYSV_TO_NATIVE_FPAIR32_RET = 12;
static const Bit32u BX_POLY_ABI_REGISTER_MAP_X86_SYSV_TO_NATIVE_FPAIR32_ARG = 13;
static const Bit32u BX_POLY_ABI_REGISTER_MAP_X86_SYSV_TO_NATIVE_HETERO_U64_F64 = 14;
static const Bit32u BX_POLY_ABI_REGISTER_MAP_X86_SYSV_TO_NATIVE_HETERO_F64_U64 = 15;
static const Bit32u BX_POLY_ABI_REGISTER_MAP_X86_SYSV_TO_NATIVE_HETERO_U64_F32 = 16;
...
enum {
  ...
  BX_POLY_RETURN_KIND_FP64 = 13,
  BX_POLY_RETURN_KIND_FP32 = 14,
  BX_POLY_RETURN_KIND_FPAIR64 = 15
};

enum {
  BX_POLY_X86_RETURN_MAP_DEFAULT = 0,
  BX_POLY_X86_RETURN_MAP_I128 = 1,
  BX_POLY_X86_RETURN_MAP_FP128 = 2,
  BX_POLY_X86_RETURN_MAP_FPAIR64 = 3,
  BX_POLY_X86_RETURN_MAP_FPAIR32 = 4,
  BX_POLY_X86_RETURN_MAP_VEC128 = 5,
  BX_POLY_X86_RETURN_MAP_FP64 = 6,
  BX_POLY_X86_RETURN_MAP_FP32 = 7,
  BX_POLY_X86_RETURN_MAP_COMPACT_U32_F32 = 8,
  BX_POLY_X86_RETURN_MAP_COMPACT_F32_U32 = 9
};
...
enum {
  ...
  BX_POLY_ARG_KIND_FP64_REGS = 14,
  BX_POLY_ARG_KIND_FP32_REGS = 15
};

enum {
  BX_POLY_CROSS_BRIDGE_DEFAULT = 0,
  BX_POLY_CROSS_BRIDGE_RESERVED_1 = 1,
...
struct bx_poly_import_x86_return_frame_t {
  ...
  bx_address saved_aarch64_tls_base;
  bx_address saved_riscv_tls_base;
  Bit64u saved_source_reg2;
};
...
static bool bx_poly_register_map_for_abi_signature_kind(Bit32u kind,
    Bit32u *register_map)
{
  switch (kind) {
  case BX_POLY_ABI_SIGNATURE_KIND_EXCHANGE:
    *register_map = BX_POLY_ABI_REGISTER_MAP_EXCHANGE;
    return true;
  case BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS:
    *register_map = BX_POLY_ABI_REGISTER_MAP_X86_SYSV_TO_NATIVE;
    return true;
  case BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_I128:
  ...
  case BX_POLY_ABI_SIGNATURE_KIND_NATIVE_REGS_I128:
    *register_map = BX_POLY_ABI_REGISTER_MAP_NATIVE_I128;
    return true;
  case BX_POLY_ABI_SIGNATURE_KIND_NATIVE_REGS_VEC128_U32:
    *register_map = BX_POLY_ABI_REGISTER_MAP_NATIVE_VEC128_U32;
    return true;
  case BX_POLY_ABI_SIGNATURE_KIND_NATIVE_REGS_COMPACT_U32_F32:
    *register_map = BX_POLY_ABI_REGISTER_MAP_NATIVE_COMPACT_U32_F32;
    return true;
  case BX_POLY_ABI_SIGNATURE_KIND_NATIVE_REGS_COMPACT_F32_U32:
  ...
  case BX_POLY_ABI_SIGNATURE_KIND_NATIVE_REGS_FP32:
    *register_map = BX_POLY_ABI_REGISTER_MAP_NATIVE_FP32;
    return true;
  case BX_POLY_ABI_SIGNATURE_KIND_SRET_X86_SYSV_REGS:
    *register_map = BX_POLY_ABI_REGISTER_MAP_SRET_X86_SYSV_TO_NATIVE;
    return true;
  case BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_FP128_RET:
    *register_map =
      BX_POLY_ABI_REGISTER_MAP_X86_SYSV_TO_NATIVE_FP128_RET;
    return true;
  case BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_FPAIR32_RET:
    *register_map =
      BX_POLY_ABI_REGISTER_MAP_X86_SYSV_TO_NATIVE_FPAIR32_RET;
    return true;
  case BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_FPAIR32_ARG:
    *register_map =
      BX_POLY_ABI_REGISTER_MAP_X86_SYSV_TO_NATIVE_FPAIR32_ARG;
    return true;
  case BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_HETERO_U64_F64:
    *register_map =
      BX_POLY_ABI_REGISTER_MAP_X86_SYSV_TO_NATIVE_HETERO_U64_F64;
    return true;
  case BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_HETERO_F64_U64:
    *register_map =
      BX_POLY_ABI_REGISTER_MAP_X86_SYSV_TO_NATIVE_HETERO_F64_U64;
    return true;
  case BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_HETERO_U64_F32:
    *register_map =
      BX_POLY_ABI_REGISTER_MAP_X86_SYSV_TO_NATIVE_HETERO_U64_F32;
    return true;
  case BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_HETERO_F32_U64:
    *register_map =
      BX_POLY_ABI_REGISTER_MAP_X86_SYSV_TO_NATIVE_HETERO_F32_U64;
    return true;
  case BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_FPAIR64_RET:
    *register_map =
      BX_POLY_ABI_REGISTER_MAP_X86_SYSV_TO_NATIVE_FPAIR64_RET;
    return true;
  ...
  case BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_MIXED_U64_FP64:
    *register_map =
    ...
    return true;
  case BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_AARCH64_HFA3_F32_RET:
    *register_map =
      BX_POLY_ABI_REGISTER_MAP_X86_SYSV_TO_AARCH64_HFA3_F32_RET;
    return true;
  ...
  case BX_POLY_ABI_SIGNATURE_KIND_NATIVE_SRET_REGS:
    *register_map = BX_POLY_ABI_REGISTER_MAP_NATIVE_SRET;
    return true;
  case BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_AARCH64_HFA3_F64_RET:
    *register_map =
      BX_POLY_ABI_REGISTER_MAP_X86_SYSV_TO_AARCH64_HFA3_F64_RET;
    return true;
  case BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_AARCH64_HFA4_F64_RET:
    *register_map =
      BX_POLY_ABI_REGISTER_MAP_X86_SYSV_TO_AARCH64_HFA4_F64_RET;
    return true;
  default:
    return false;
  }
...
static bool bx_poly_decode_abi_signature_value(Bit64u value, Bit32u *kind)
{
  Bit32u decoded_kind = (Bit32u) value;
...
{
  bx_poly_set_abi_signature_slot(&slots[0],
    BX_POLY_ABI_SIGNATURE_KIND_EXCHANGE);
  for (unsigned n = 1; n < BX_POLY_ABI_SIGNATURE_SLOT_COUNT; n++)
    bx_poly_set_abi_signature_slot(&slots[n],
      BX_POLY_ABI_SIGNATURE_KIND_EXCHANGE);
  bx_poly_set_abi_signature_slot(
    &slots[BX_POLY_ABI_SIGNATURE_SLOT_X86_SYSV_REGS],
    BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS);
  bx_poly_set_abi_signature_slot(
    &slots[BX_POLY_ABI_SIGNATURE_SLOT_X86_SYSV_REGS_I128],
    BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_I128);
  bx_poly_set_abi_signature_slot(
    &slots[BX_POLY_ABI_SIGNATURE_SLOT_NATIVE_REGS],
    BX_POLY_ABI_SIGNATURE_KIND_NATIVE_REGS);
  bx_poly_set_abi_signature_slot(
    &slots[BX_POLY_ABI_SIGNATURE_SLOT_NATIVE_REGS_I128],
    BX_POLY_ABI_SIGNATURE_KIND_NATIVE_REGS_I128);
  bx_poly_set_abi_signature_slot(
    &slots[BX_POLY_ABI_SIGNATURE_SLOT_NATIVE_REGS_VEC128_U32],
    BX_POLY_ABI_SIGNATURE_KIND_NATIVE_REGS_VEC128_U32);
  bx_poly_set_abi_signature_slot(
    &slots[BX_POLY_ABI_SIGNATURE_SLOT_NATIVE_REGS_COMPACT_U32_F32],
  ...
  bx_poly_set_abi_signature_slot(
    &slots[BX_POLY_ABI_SIGNATURE_SLOT_SRET_X86_SYSV_REGS],
...
enum {
  ...
  BX_POLY_RISCV_FFLAGS_MASK = 0x1f,
  BX_POLY_RISCV_FRM_MASK = 0x7,
...
static const Bit8u bx_poly_aes_sbox[256] = {
...
static const Bit8u bx_poly_aes_inverse_sbox[256] = {
...
static Bit8u bx_poly_aes_gf_mul(Bit8u a, Bit8u b)
{
  Bit32u left = a, right = b, result = 0;
...
static void bx_poly_aes_load(Bit64u lo, Bit64u hi, Bit8u state[16])
{
  for (Bit32u byte = 0; byte < 16; byte++)
    state[byte] = (Bit8u) bx_poly_get_vector_element(lo, hi, 8, byte);
}

static void bx_poly_aes_store(const Bit8u state[16], Bit64u *lo, Bit64u *hi)
{
  *lo = 0;
  *hi = 0;
  for (Bit32u byte = 0; byte < 16; byte++)
    bx_poly_set_vector_element(lo, hi, 8, byte, state[byte]);
}

static void bx_poly_aes_shift_rows(Bit8u state[16], bool inverse)
{
  static const Bit8u shift[16] =
    { 0, 5, 10, 15, 4, 9, 14, 3, 8, 13, 2, 7, 12, 1, 6, 11 };
  static const Bit8u inverse_shift[16] =
    { 0, 13, 10, 7, 4, 1, 14, 11, 8, 5, 2, 15, 12, 9, 6, 3 };
  Bit8u tmp[16];

  for (Bit32u byte = 0; byte < 16; byte++)
    tmp[byte] = state[inverse ? inverse_shift[byte] : shift[byte]];
  for (Bit32u byte = 0; byte < 16; byte++)
    state[byte] = tmp[byte];
}

static void bx_poly_aes_substitute(Bit8u state[16], bool inverse)
{
  for (Bit32u byte = 0; byte < 16; byte++)
    state[byte] = inverse ? bx_poly_aes_inverse_sbox[state[byte]] :
      bx_poly_aes_sbox[state[byte]];
}

static void bx_poly_aes_mix_columns(Bit8u state[16], bool inverse)
{
  Bit8u tmp[16];
  ...
  for (Bit32u col = 0; col < 4; col++) {
    Bit32u b = col * 4;
    if (inverse) {
      state[b + 0] = bx_poly_aes_gf_mul(0x0e, tmp[b + 0]) ^
                     bx_poly_aes_gf_mul(0x0b, tmp[b + 1]) ^
                     bx_poly_aes_gf_mul(0x0d, tmp[b + 2]) ^
                     bx_poly_aes_gf_mul(0x09, tmp[b + 3]);
      state[b + 1] = bx_poly_aes_gf_mul(0x09, tmp[b + 0]) ^
                     bx_poly_aes_gf_mul(0x0e, tmp[b + 1]) ^
                     bx_poly_aes_gf_mul(0x0b, tmp[b + 2]) ^
                     bx_poly_aes_gf_mul(0x0d, tmp[b + 3]);
      state[b + 2] = bx_poly_aes_gf_mul(0x0d, tmp[b + 0]) ^
                     bx_poly_aes_gf_mul(0x09, tmp[b + 1]) ^
                     bx_poly_aes_gf_mul(0x0e, tmp[b + 2]) ^
                     bx_poly_aes_gf_mul(0x0b, tmp[b + 3]);
      state[b + 3] = bx_poly_aes_gf_mul(0x0b, tmp[b + 0]) ^
                     bx_poly_aes_gf_mul(0x0d, tmp[b + 1]) ^
                     bx_poly_aes_gf_mul(0x09, tmp[b + 2]) ^
                     bx_poly_aes_gf_mul(0x0e, tmp[b + 3]);
    }
    else {
      state[b + 0] = bx_poly_aes_gf_mul(0x02, tmp[b + 0]) ^
                     bx_poly_aes_gf_mul(0x03, tmp[b + 1]) ^
                     tmp[b + 2] ^ tmp[b + 3];
      state[b + 1] = tmp[b + 0] ^
                     bx_poly_aes_gf_mul(0x02, tmp[b + 1]) ^
                     bx_poly_aes_gf_mul(0x03, tmp[b + 2]) ^
                     tmp[b + 3];
      state[b + 2] = tmp[b + 0] ^ tmp[b + 1] ^
                     bx_poly_aes_gf_mul(0x02, tmp[b + 2]) ^
                     bx_poly_aes_gf_mul(0x03, tmp[b + 3]);
      state[b + 3] = bx_poly_aes_gf_mul(0x03, tmp[b + 0]) ^
                     tmp[b + 1] ^ tmp[b + 2] ^
                     bx_poly_aes_gf_mul(0x02, tmp[b + 3]);
    }
  }
}

static void bx_poly_aes_round(Bit64u *lo, Bit64u *hi, Bit64u key_lo,
    Bit64u key_hi, bool decrypt)
{
  Bit8u state[16];
  Bit8u key[16];

  bx_poly_aes_load(*lo, *hi, state);
  bx_poly_aes_load(key_lo, key_hi, key);
  for (Bit32u byte = 0; byte < 16; byte++)
    state[byte] ^= key[byte];
  bx_poly_aes_shift_rows(state, decrypt);
  bx_poly_aes_substitute(state, decrypt);
  bx_poly_aes_store(state, lo, hi);
}

static void bx_poly_aes_mix_vector(Bit64u source_lo, Bit64u source_hi,
    Bit64u *result_lo, Bit64u *result_hi, bool inverse)
{
  Bit8u state[16];

  bx_poly_aes_load(source_lo, source_hi, state);
  bx_poly_aes_mix_columns(state, inverse);
...
static const Bit8u bx_poly_sm4_sbox[256] = {
...
static Bit32u bx_poly_sm4_substitute(Bit32u value)
{
  Bit32u result = 0;
  for (Bit32u byte = 0; byte < 4; byte++) {
    Bit32u data = (value >> (byte * 8)) & 0xff;
    result |= ((Bit32u) bx_poly_sm4_sbox[data]) << (byte * 8);
  }
  return result;
}

static Bit32u bx_poly_sm4_round_transform(Bit32u value)
{
  value = bx_poly_sm4_substitute(value);
  return value ^
         (Bit32u) bx_poly_rotate_left(value, 32, 2) ^
         (Bit32u) bx_poly_rotate_left(value, 32, 10) ^
         (Bit32u) bx_poly_rotate_left(value, 32, 18) ^
         (Bit32u) bx_poly_rotate_left(value, 32, 24);
}

static Bit32u bx_poly_sm4_key_transform(Bit32u value)
{
  value = bx_poly_sm4_substitute(value);
  return value ^
         (Bit32u) bx_poly_rotate_left(value, 32, 13) ^
         (Bit32u) bx_poly_rotate_left(value, 32, 23);
}

static void bx_poly_sm4_four_rounds(Bit64u state_lo, Bit64u state_hi,
    Bit64u key_lo, Bit64u key_hi, bool key_schedule,
    Bit64u *result_lo, Bit64u *result_hi)
{
  Bit32u state[4], key[4];

  bx_poly_load_u32x4(state_lo, state_hi, state);
  bx_poly_load_u32x4(key_lo, key_hi, key);
  for (Bit32u i = 0; i < 4; i++) {
    Bit32u value = state[1] ^ state[2] ^ state[3] ^ key[i];
    value = key_schedule ? bx_poly_sm4_key_transform(value) :
      bx_poly_sm4_round_transform(value);
    value ^= state[0];
    state[0] = state[1];
    state[1] = state[2];
    state[2] = state[3];
    ...
    bx_poly_import_x86_return_frame_t *frame)
{
  ...
  frame->saved_aarch64_tls_base = 0;
  frame->saved_riscv_tls_base = 0;
  frame->saved_source_reg2 = 0;
}
...
static Bit32u bx_poly_xsave_arch_flags(void)
{
  return BX_POLY_STATE_XSAVE_FLAG_XCR0_USER |
    ...
    BX_POLY_STATE_XSAVE_FLAG_COMPLETE_BANK_EXPORT |
...
bool BX_CPU_C::export_poly_xsave_state(unsigned seg, bx_address base)
{
  ...
  write_virtual_qword(seg, base + BX_POLY_STATE_XSAVE_AARCH64_STATUS_OFFSET + 32,
    bx_poly_aarch64_reservation_size);
  write_virtual_qword(seg, base + BX_POLY_STATE_XSAVE_RISCV_STATUS_OFFSET,
    ((Bit64u) (bx_poly_riscv_frm & BX_POLY_RISCV_FRM_MASK) << 5) |
    (bx_poly_riscv_fflags & BX_POLY_RISCV_FFLAGS_MASK));
  ...
  for (unsigned n = 0; n < import_top; n++) {
    ...
    write_virtual_qword(seg, frame_base + 104,
      frame->saved_aarch64_tls_base);
    write_virtual_qword(seg, frame_base + 112,
      frame->saved_riscv_tls_base);
    write_virtual_qword(seg, frame_base + 120,
  ...
  for (unsigned n = 0; n < BX_POLY_ABI_SIGNATURE_SLOT_COUNT; n++) {
    write_virtual_qword(seg,
      ...
      (Bit64u) bx_poly_abi_signature_slots[n].kind |
      ((Bit64u) bx_poly_abi_signature_slots[n].register_map << 32));
  }
  ...
  if (bx_poly_trap_saved_regs.valid) {
    bx_address restore_base = base + BX_POLY_STATE_XSAVE_TRAP_RESTORE_OFFSET;
    Bit64u restore_flags = BX_POLY_TRAP_RESTORE_FLAG_VALID;
    if (bx_poly_trap_saved_regs.aarch64_state_valid)
      restore_flags |= BX_POLY_TRAP_RESTORE_FLAG_AARCH64_STATE_VALID;
    if (bx_poly_trap_saved_regs.riscv_state_valid)
      restore_flags |= BX_POLY_TRAP_RESTORE_FLAG_RISCV_STATE_VALID;
    write_virtual_qword(seg, restore_base +
      BX_POLY_STATE_XSAVE_TRAP_RESTORE_FLAGS_OFFSET, restore_flags);
    write_virtual_qword(seg, restore_base +
      BX_POLY_STATE_XSAVE_TRAP_RESTORE_MODE_OFFSET,
      bx_poly_trap_saved_regs.mode);

    const Bit64u x86_gpr[16] = {
      bx_poly_trap_saved_regs.rax, bx_poly_trap_saved_regs.rbx,
      bx_poly_trap_saved_regs.rbp, bx_poly_trap_saved_regs.rdi,
      bx_poly_trap_saved_regs.rsi, bx_poly_trap_saved_regs.rdx,
      bx_poly_trap_saved_regs.rcx, bx_poly_trap_saved_regs.r8,
      bx_poly_trap_saved_regs.r9, bx_poly_trap_saved_regs.r10,
      bx_poly_trap_saved_regs.r11, bx_poly_trap_saved_regs.r12,
      bx_poly_trap_saved_regs.r13, bx_poly_trap_saved_regs.r14,
      bx_poly_trap_saved_regs.r15, bx_poly_trap_saved_regs.rsp
    };
    for (unsigned n = 0; n < 16; n++)
      write_virtual_qword(seg, restore_base +
        BX_POLY_STATE_XSAVE_TRAP_RESTORE_X86_GPR_OFFSET + n * 8,
        x86_gpr[n]);
    for (unsigned n = 0; n < BX_POLY_TRAP_SAVED_XMM_COUNT; n++) {
      bx_address xmm_base = restore_base +
        BX_POLY_STATE_XSAVE_TRAP_RESTORE_X86_XMM_OFFSET + n * 16;
      write_virtual_qword(seg, xmm_base, bx_poly_trap_saved_regs.xmm_lo[n]);
      write_virtual_qword(seg, xmm_base + 8,
        bx_poly_trap_saved_regs.xmm_hi[n]);
    }

    Bit64u aarch64_valid_mask = 0;
    Bit64u riscv_valid_mask = 0;
    for (unsigned n = 0; n < 32; n++) {
      if (bx_poly_trap_saved_regs.aarch64_x_valid[n])
        aarch64_valid_mask |= (BX_CONST64(1) << n);
      if (bx_poly_trap_saved_regs.riscv_x_valid[n])
        riscv_valid_mask |= (BX_CONST64(1) << n);
    }
    write_virtual_qword(seg, restore_base +
      BX_POLY_STATE_XSAVE_TRAP_RESTORE_AARCH64_VALID_OFFSET,
      aarch64_valid_mask);
    write_virtual_qword(seg, restore_base +
      BX_POLY_STATE_XSAVE_TRAP_RESTORE_RISCV_VALID_OFFSET,
      riscv_valid_mask);
    for (unsigned n = 0; n < 32; n++) {
      write_virtual_qword(seg, restore_base +
        BX_POLY_STATE_XSAVE_TRAP_RESTORE_AARCH64_GPR_OFFSET + n * 8,
        bx_poly_trap_saved_regs.aarch64_x[n]);
      write_virtual_qword(seg, restore_base +
        BX_POLY_STATE_XSAVE_TRAP_RESTORE_AARCH64_FP_OFFSET + n * 16,
        bx_poly_trap_saved_regs.aarch64_fp[n]);
      write_virtual_qword(seg, restore_base +
        BX_POLY_STATE_XSAVE_TRAP_RESTORE_AARCH64_FP_OFFSET + n * 16 + 8,
        bx_poly_trap_saved_regs.aarch64_fp_hi[n]);
      write_virtual_qword(seg, restore_base +
        BX_POLY_STATE_XSAVE_TRAP_RESTORE_RISCV_GPR_OFFSET + n * 8,
        bx_poly_trap_saved_regs.riscv_x[n]);
      write_virtual_qword(seg, restore_base +
        BX_POLY_STATE_XSAVE_TRAP_RESTORE_RISCV_FP_OFFSET + n * 16,
        bx_poly_trap_saved_regs.riscv_fp[n]);
      write_virtual_qword(seg, restore_base +
        BX_POLY_STATE_XSAVE_TRAP_RESTORE_RISCV_FP_OFFSET + n * 16 + 8,
        bx_poly_trap_saved_regs.riscv_fp_hi[n]);
    }
    write_virtual_qword(seg, restore_base +
      BX_POLY_STATE_XSAVE_TRAP_RESTORE_AARCH64_STATUS_OFFSET,
      bx_poly_trap_saved_regs.aarch64_nzcv);
    write_virtual_qword(seg, restore_base +
      BX_POLY_STATE_XSAVE_TRAP_RESTORE_AARCH64_STATUS_OFFSET + 8,
      bx_poly_trap_saved_regs.aarch64_fpcr);
    write_virtual_qword(seg, restore_base +
      BX_POLY_STATE_XSAVE_TRAP_RESTORE_AARCH64_STATUS_OFFSET + 16,
      bx_poly_trap_saved_regs.aarch64_fpsr);
    write_virtual_qword(seg, restore_base +
      BX_POLY_STATE_XSAVE_TRAP_RESTORE_RISCV_FCSR_OFFSET,
...
bool BX_CPU_C::import_poly_xsave_state(unsigned seg, bx_address base)
{
  ...
  if (!bx_poly_valid_trap_vector_target(imported_trap_vector,
      ...
      !bx_poly_valid_monitor_packet_target(imported_monitor_packet,
        BX_CPU_THIS_PTR linaddr_width)) {
  ...
  bx_address restore_base = base + BX_POLY_STATE_XSAVE_TRAP_RESTORE_OFFSET;
  Bit64u restore_flags = read_virtual_qword(seg, restore_base +
    BX_POLY_STATE_XSAVE_TRAP_RESTORE_FLAGS_OFFSET);
  Bit64u restore_mode_word = read_virtual_qword(seg, restore_base +
    BX_POLY_STATE_XSAVE_TRAP_RESTORE_MODE_OFFSET);
  Bit32u restore_mode = (Bit32u) restore_mode_word;
  bool restore_valid =
    (restore_flags & BX_POLY_TRAP_RESTORE_FLAG_VALID) != 0;
  if ((restore_flags & ~BX_POLY_TRAP_RESTORE_FLAGS_SUPPORTED) != 0 ||
      (restore_mode_word >> 32) != 0) {
    BX_INFO(("poly_state_import: reject trap restore flags=%llx mode_word=%llx",
      (unsigned long long) restore_flags,
      (unsigned long long) restore_mode_word));
    return false;
  }
  if (!restore_valid) {
    if (restore_flags != 0 || restore_mode_word != 0 ||
        !reserved_qwords_are_zero(
          BX_POLY_STATE_XSAVE_TRAP_RESTORE_OFFSET + 16,
          BX_POLY_STATE_XSAVE_TRAP_RESTORE_BYTES - 16,
          "inactive trap restore")) {
      BX_INFO(("poly_state_import: reject inactive trap restore flags=%llx mode=%u",
        (unsigned long long) restore_flags, restore_mode));
      return false;
    }
    ...
    if (!bx_poly_is_raw_mode(restore_mode) ||
    ...
    const bool restore_aarch64 =
      (restore_flags & BX_POLY_TRAP_RESTORE_FLAG_AARCH64_STATE_VALID) != 0;
    const bool restore_riscv =
      (restore_flags & BX_POLY_TRAP_RESTORE_FLAG_RISCV_STATE_VALID) != 0;
    if ((restore_mode == BX_POLY_MODE_RAW_AARCH64 &&
          (!restore_aarch64 || restore_riscv)) ||
        (restore_mode == BX_POLY_MODE_RAW_RISCV &&
          (!restore_riscv || restore_aarch64))) {
      BX_INFO(("poly_state_import: reject trap restore state flags=%llx mode=%u",
        (unsigned long long) restore_flags, restore_mode));
      return false;
    }

    Bit64u aarch64_valid_mask = read_virtual_qword(seg, restore_base +
      BX_POLY_STATE_XSAVE_TRAP_RESTORE_AARCH64_VALID_OFFSET);
    Bit64u riscv_valid_mask = read_virtual_qword(seg, restore_base +
      BX_POLY_STATE_XSAVE_TRAP_RESTORE_RISCV_VALID_OFFSET);
    const Bit64u aarch64_expected_mask = (BX_CONST64(1) << 31) - 1;
    const Bit64u riscv_expected_mask = BX_CONST64(0xffffffff);
    if ((restore_mode == BX_POLY_MODE_RAW_AARCH64 &&
          (aarch64_valid_mask != aarch64_expected_mask ||
           riscv_valid_mask != 0)) ||
        (restore_mode == BX_POLY_MODE_RAW_RISCV &&
          (riscv_valid_mask != riscv_expected_mask ||
           aarch64_valid_mask != 0))) {
      BX_INFO(("poly_state_import: reject trap restore masks a64=%llx rv=%llx mode=%u",
        (unsigned long long) aarch64_valid_mask,
        (unsigned long long) riscv_valid_mask, restore_mode));
      return false;
    }

    imported_trap_restore.valid = true;
    imported_trap_restore.mode = restore_mode;
    Bit64u x86_gpr[16];
    for (unsigned n = 0; n < 16; n++)
      x86_gpr[n] = read_virtual_qword(seg, restore_base +
        BX_POLY_STATE_XSAVE_TRAP_RESTORE_X86_GPR_OFFSET + n * 8);
    imported_trap_restore.rax = x86_gpr[0];
    imported_trap_restore.rbx = x86_gpr[1];
    imported_trap_restore.rbp = x86_gpr[2];
    imported_trap_restore.rdi = x86_gpr[3];
    imported_trap_restore.rsi = x86_gpr[4];
    imported_trap_restore.rdx = x86_gpr[5];
    imported_trap_restore.rcx = x86_gpr[6];
    imported_trap_restore.r8 = x86_gpr[7];
    imported_trap_restore.r9 = x86_gpr[8];
    imported_trap_restore.r10 = x86_gpr[9];
    imported_trap_restore.r11 = x86_gpr[10];
    imported_trap_restore.r12 = x86_gpr[11];
    imported_trap_restore.r13 = x86_gpr[12];
    imported_trap_restore.r14 = x86_gpr[13];
    imported_trap_restore.r15 = x86_gpr[14];
    imported_trap_restore.rsp = x86_gpr[15];
    if (!bx_poly_valid_control_address(imported_trap_restore.rsp,
          BX_CPU_THIS_PTR linaddr_width)) {
      BX_INFO(("poly_state_import: reject trap restore rsp=%llx",
        (unsigned long long) imported_trap_restore.rsp));
      return false;
    }
    for (unsigned n = 0; n < BX_POLY_TRAP_SAVED_XMM_COUNT; n++) {
      bx_address xmm_base = restore_base +
        BX_POLY_STATE_XSAVE_TRAP_RESTORE_X86_XMM_OFFSET + n * 16;
      imported_trap_restore.xmm_lo[n] = read_virtual_qword(seg, xmm_base);
      imported_trap_restore.xmm_hi[n] = read_virtual_qword(seg, xmm_base + 8);
    }

    imported_trap_restore.aarch64_state_valid = restore_aarch64;
    imported_trap_restore.riscv_state_valid = restore_riscv;
    bool inactive_restore_payload_nonzero = false;
    for (unsigned n = 0; n < 32; n++) {
      imported_trap_restore.aarch64_x_valid[n] =
        (aarch64_valid_mask & (BX_CONST64(1) << n)) != 0;
      imported_trap_restore.aarch64_x[n] = read_virtual_qword(seg,
        restore_base + BX_POLY_STATE_XSAVE_TRAP_RESTORE_AARCH64_GPR_OFFSET +
        n * 8);
      imported_trap_restore.aarch64_fp[n] = read_virtual_qword(seg,
        restore_base + BX_POLY_STATE_XSAVE_TRAP_RESTORE_AARCH64_FP_OFFSET +
        n * 16);
      imported_trap_restore.aarch64_fp_hi[n] = read_virtual_qword(seg,
        restore_base + BX_POLY_STATE_XSAVE_TRAP_RESTORE_AARCH64_FP_OFFSET +
        n * 16 + 8);
      imported_trap_restore.riscv_x_valid[n] =
        (riscv_valid_mask & (BX_CONST64(1) << n)) != 0;
      imported_trap_restore.riscv_x[n] = read_virtual_qword(seg,
        restore_base + BX_POLY_STATE_XSAVE_TRAP_RESTORE_RISCV_GPR_OFFSET +
        n * 8);
      imported_trap_restore.riscv_fp[n] = read_virtual_qword(seg,
        restore_base + BX_POLY_STATE_XSAVE_TRAP_RESTORE_RISCV_FP_OFFSET +
        n * 16);
      imported_trap_restore.riscv_fp_hi[n] = read_virtual_qword(seg,
        restore_base + BX_POLY_STATE_XSAVE_TRAP_RESTORE_RISCV_FP_OFFSET +
        n * 16 + 8);
      if (restore_mode == BX_POLY_MODE_RAW_AARCH64 &&
          (imported_trap_restore.riscv_x[n] != 0 ||
           imported_trap_restore.riscv_fp[n] != 0 ||
           imported_trap_restore.riscv_fp_hi[n] != 0))
        inactive_restore_payload_nonzero = true;
      if (restore_mode == BX_POLY_MODE_RAW_RISCV &&
          (imported_trap_restore.aarch64_x[n] != 0 ||
           imported_trap_restore.aarch64_fp[n] != 0 ||
           imported_trap_restore.aarch64_fp_hi[n] != 0))
        inactive_restore_payload_nonzero = true;
    }
    Bit64u restore_aarch64_nzcv = read_virtual_qword(seg, restore_base +
      BX_POLY_STATE_XSAVE_TRAP_RESTORE_AARCH64_STATUS_OFFSET);
    Bit64u restore_aarch64_fpcr = read_virtual_qword(seg, restore_base +
      BX_POLY_STATE_XSAVE_TRAP_RESTORE_AARCH64_STATUS_OFFSET + 8);
    Bit64u restore_aarch64_fpsr = read_virtual_qword(seg, restore_base +
      BX_POLY_STATE_XSAVE_TRAP_RESTORE_AARCH64_STATUS_OFFSET + 16);
    Bit64u restore_aarch64_reserved = read_virtual_qword(seg, restore_base +
      BX_POLY_STATE_XSAVE_TRAP_RESTORE_AARCH64_STATUS_OFFSET + 24);
    Bit64u restore_riscv_fcsr = read_virtual_qword(seg, restore_base +
      BX_POLY_STATE_XSAVE_TRAP_RESTORE_RISCV_FCSR_OFFSET);
    if ((restore_aarch64_nzcv & ~((Bit64u) BX_POLY_AARCH64_NZCV_MASK)) != 0 ||
        (restore_aarch64_fpcr & ~((Bit64u) BX_POLY_AARCH64_FPCR_RMODE_MASK)) != 0 ||
        (restore_aarch64_fpsr & ~((Bit64u) BX_POLY_AARCH64_FPSR_MASK)) != 0 ||
        (restore_riscv_fcsr & ~((Bit64u) BX_POLY_RISCV_FCSR_MASK)) != 0 ||
        (restore_mode == BX_POLY_MODE_RAW_AARCH64 &&
          restore_riscv_fcsr != 0) ||
        (restore_mode == BX_POLY_MODE_RAW_RISCV &&
          (restore_aarch64_nzcv != 0 || restore_aarch64_fpcr != 0 ||
           restore_aarch64_fpsr != 0)) ||
        restore_aarch64_reserved != 0 ||
        inactive_restore_payload_nonzero ||
        !reserved_qwords_are_zero(
          BX_POLY_STATE_XSAVE_TRAP_RESTORE_RESERVED_OFFSET +
          BX_POLY_STATE_XSAVE_TRAP_RESTORE_OFFSET,
          BX_POLY_STATE_XSAVE_TRAP_RESTORE_RESERVED_BYTES,
          "trap restore reserved")) {
      BX_INFO(("poly_state_import: reject trap restore status a64=%llx/%llx/%llx rv=%llx reserved=%llx",
        (unsigned long long) restore_aarch64_nzcv,
        (unsigned long long) restore_aarch64_fpcr,
        (unsigned long long) restore_aarch64_fpsr,
        (unsigned long long) restore_riscv_fcsr,
        (unsigned long long) restore_aarch64_reserved));
      return false;
    }
    imported_trap_restore.aarch64_nzcv = (Bit32u) restore_aarch64_nzcv;
    imported_trap_restore.aarch64_fpcr = (Bit32u) restore_aarch64_fpcr;
    imported_trap_restore.aarch64_fpsr = (Bit32u) restore_aarch64_fpsr;
    imported_trap_restore.riscv_fflags =
      (Bit32u) restore_riscv_fcsr & BX_POLY_RISCV_FFLAGS_MASK;
    imported_trap_restore.riscv_frm =
      ((Bit32u) restore_riscv_fcsr >> 5) & BX_POLY_RISCV_FRM_MASK;
  }
  for (unsigned n = 0; n < 32; n++) {
  ...
  for (unsigned n = 0; n < import_top; n++) {
    ...
    if (!bx_poly_is_raw_mode(frame->mode) ||
        (!direct_x86_frame && frame->import_id >= BX_POLY_IMPORT_TRAP_SLOT_COUNT)) {
    ...
    frame->saved_aarch64_tls_base =
      read_virtual_qword(seg, frame_base + 104);
    frame->saved_riscv_tls_base =
      read_virtual_qword(seg, frame_base + 112);
    frame->saved_source_reg2 =
  ...
  for (unsigned n = 0; n < BX_POLY_ABI_SIGNATURE_SLOT_COUNT; n++) {
    Bit64u slot_value = read_virtual_qword(seg,
      base + BX_POLY_STATE_XSAVE_ABI_SIGNATURE_SLOTS_OFFSET + n * 8);
    ...
    abi_signature_slots[n].register_map = register_map;
  }
  if (!reserved_qwords_are_zero(
  ...
  bx_poly_clear_trap_saved_regs(&bx_poly_trap_saved_regs);
  if (imported_trap_restore.valid)
    bx_poly_trap_saved_regs = imported_trap_restore;
...
static bool bx_poly_valid_abi_signature_kind(Bit32u kind)
{
  return kind == BX_POLY_ABI_SIGNATURE_KIND_EXCHANGE ||
    ...
    kind == BX_POLY_ABI_SIGNATURE_KIND_SRET_X86_SYSV_REGS ||
    kind == BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_FP128_RET ||
    kind == BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_FPAIR32_RET ||
    kind == BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_FPAIR32_ARG ||
    kind == BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_HETERO_U64_F64 ||
    kind == BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_HETERO_F64_U64 ||
  ...
  Bit32u *bridge_kind)
{
  ...
  if (kind == BX_POLY_ABI_SIGNATURE_KIND_NATIVE_REGS_FP32) {
    *bridge_kind = BX_POLY_CROSS_BRIDGE_FP32;
    return true;
  }
  ...
  Bit32u source_kind, bool copy_foreign_stack_args)
{
  ...
  if (sret_call && !copy_foreign_stack_args &&
  ...
  else if (sret_call && !copy_foreign_stack_args &&
    ...
    stack_copy_base = original_rsp + 24;
      ...
      source_kind == BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_FP128_RET ||
      ...
      source_kind == BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_HETERO_U64_F64 ||
      source_kind == BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_HETERO_F64_U64 ||
      ...
      source_kind == BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_AARCH64_HFA3_F64_RET ||
      source_kind == BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_AARCH64_HFA4_F64_RET) {
    args[0] = RDI;
    args[1] = RSI;
    args[2] = RDX;
    args[3] = RCX;
  ...
  if (mode == BX_POLY_MODE_RAW_AARCH64) {
    ...
    else if (mapped && arg_kind == BX_POLY_ARG_KIND_FP64_REGS) {
      for (Bit32u n = 0; mapped && n < BX_POLY_ABI_BRIDGE_FP_ARG_COUNT; n++)
        mapped = write_poly_aarch64_fp64_reg(n, fp_args[n]);
    }
    ...
    if (mapped && arg_kind == BX_POLY_ARG_KIND_FPAIR32) {
      ...
      for (Bit32u n = 0; mapped && n < BX_POLY_ABI_BRIDGE_FP_ARG_COUNT; n++)
        mapped = write_poly_riscv_fp64_reg(10 + n, fp_args[n]);
    }
    else if (mapped && arg_kind == BX_POLY_ARG_KIND_FP32_REGS) {
      for (Bit32u n = 0; mapped && n < BX_POLY_ABI_BRIDGE_FP_ARG_COUNT; n++)
        mapped = write_poly_riscv_fp32_reg(10 + n, (Bit32u) fp_args[n]);
    }
  }
  else {
    mapped = false;
  ...
  Bit32u return_kind, Bit32u arg_kind, Bit32u slot)
{
  ...
  else if (source_kind == BX_POLY_ABI_SIGNATURE_KIND_NATIVE_REGS_COMPACT_U32_F32 &&
      return_kind == BX_POLY_RETURN_KIND_DEFAULT &&
      arg_kind == BX_POLY_ARG_KIND_DEFAULT) {
    return_kind = BX_POLY_RETURN_KIND_COMPACT_U32_F32;
    arg_kind = BX_POLY_ARG_KIND_COMPACT_U32_F32;
  }
  else if (source_kind == BX_POLY_ABI_SIGNATURE_KIND_NATIVE_REGS_COMPACT_F32_U32 &&
      return_kind == BX_POLY_RETURN_KIND_DEFAULT &&
      arg_kind == BX_POLY_ARG_KIND_DEFAULT) {
    return_kind = BX_POLY_RETURN_KIND_COMPACT_F32_U32;
    arg_kind = BX_POLY_ARG_KIND_COMPACT_F32_U32;
  }
  else if (source_kind == BX_POLY_ABI_SIGNATURE_KIND_NATIVE_REGS_FP64 &&
      return_kind == BX_POLY_RETURN_KIND_DEFAULT &&
      arg_kind == BX_POLY_ARG_KIND_DEFAULT) {
  ...
  else if (source_kind == BX_POLY_ABI_SIGNATURE_KIND_SRET_X86_SYSV_REGS &&
      return_kind == BX_POLY_RETURN_KIND_DEFAULT &&
      arg_kind == BX_POLY_ARG_KIND_DEFAULT) {
    sret_call = true;
  }
  else if (source_kind == BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_FPAIR32_RET &&
      return_kind == BX_POLY_RETURN_KIND_DEFAULT &&
      arg_kind == BX_POLY_ARG_KIND_DEFAULT) {
    return_kind = BX_POLY_RETURN_KIND_FPAIR32;
    arg_kind = BX_POLY_ARG_KIND_FP32_REGS;
  }
  else if (source_kind == BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_FPAIR32_ARG &&
      return_kind == BX_POLY_RETURN_KIND_DEFAULT &&
      arg_kind == BX_POLY_ARG_KIND_DEFAULT) {
    return_kind = BX_POLY_RETURN_KIND_FP32;
    arg_kind = BX_POLY_ARG_KIND_FPAIR32;
  }
  else if (source_kind == BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_FPAIR64_RET &&
      return_kind == BX_POLY_RETURN_KIND_DEFAULT &&
      arg_kind == BX_POLY_ARG_KIND_DEFAULT) {
    return_kind = BX_POLY_RETURN_KIND_FPAIR64;
    arg_kind = BX_POLY_ARG_KIND_FP64_REGS;
  }
  ...
  else if (source_kind == BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_HETERO_U64_F64 &&
      return_kind == BX_POLY_RETURN_KIND_DEFAULT &&
      arg_kind == BX_POLY_ARG_KIND_DEFAULT) {
    return_kind = BX_POLY_RETURN_KIND_HETERO_U64_F64;
    arg_kind = BX_POLY_ARG_KIND_HETERO_U64_F64;
  }
  else if (source_kind == BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_HETERO_F64_U64 &&
      return_kind == BX_POLY_RETURN_KIND_DEFAULT &&
      arg_kind == BX_POLY_ARG_KIND_DEFAULT) {
    return_kind = BX_POLY_RETURN_KIND_HETERO_F64_U64;
    arg_kind = BX_POLY_ARG_KIND_HETERO_F64_U64;
  }
  else if (source_kind == BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_HETERO_U64_F32 &&
      return_kind == BX_POLY_RETURN_KIND_DEFAULT &&
      arg_kind == BX_POLY_ARG_KIND_DEFAULT) {
    return_kind = BX_POLY_RETURN_KIND_HETERO_U64_F32;
    arg_kind = BX_POLY_ARG_KIND_HETERO_U64_F32;
  }
  else if (source_kind == BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_HETERO_F32_U64 &&
      return_kind == BX_POLY_RETURN_KIND_DEFAULT &&
      arg_kind == BX_POLY_ARG_KIND_DEFAULT) {
    return_kind = BX_POLY_RETURN_KIND_HETERO_F32_U64;
    arg_kind = BX_POLY_ARG_KIND_HETERO_F32_U64;
  }
  else if (source_kind == BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_AARCH64_HFA3_F32_RET &&
      return_kind == BX_POLY_RETURN_KIND_DEFAULT &&
      arg_kind == BX_POLY_ARG_KIND_DEFAULT) {
    return_kind = BX_POLY_RETURN_KIND_AARCH64_HFA3_F32;
    arg_kind = BX_POLY_ARG_KIND_FP32_REGS;
  }
  else if (source_kind == BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_AARCH64_HFA4_F32_RET &&
      return_kind == BX_POLY_RETURN_KIND_DEFAULT &&
      arg_kind == BX_POLY_ARG_KIND_DEFAULT) {
  ...
  else if (source_kind == BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_AARCH64_HFA3_F64_RET &&
      return_kind == BX_POLY_RETURN_KIND_DEFAULT &&
      arg_kind == BX_POLY_ARG_KIND_DEFAULT) {
    return_kind = BX_POLY_RETURN_KIND_AARCH64_HFA3_F64;
    arg_kind = BX_POLY_ARG_KIND_FP64_REGS;
  }
  else if (source_kind == BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_AARCH64_HFA4_F64_RET &&
      return_kind == BX_POLY_RETURN_KIND_DEFAULT &&
      arg_kind == BX_POLY_ARG_KIND_DEFAULT) {
...
bool BX_CPU_C::return_poly_abi_call(Bit32u mode, bx_address target_rip)
{
  ...
  Bit64u fpair64_lo = 0, fpair64_hi = 0;
  bool has_fpair64_result = false;
  ...
  else if (return_kind == BX_POLY_RETURN_KIND_FPAIR64) {
    if (mode == BX_POLY_MODE_RAW_AARCH64)
      has_fpair64_result =
        read_poly_aarch64_fp64_reg(0, &fpair64_lo) &&
        read_poly_aarch64_fp64_reg(1, &fpair64_hi);
    else if (mode == BX_POLY_MODE_RAW_RISCV)
      has_fpair64_result =
        read_poly_riscv_fp64_reg(10, &fpair64_lo) &&
        read_poly_riscv_fp64_reg(11, &fpair64_hi);
  }
  ...
  else if (return_kind == BX_POLY_RETURN_KIND_FP64 &&
      mode == BX_POLY_MODE_RAW_AARCH64) {
    has_second_result = read_poly_aarch64_fp64_reg(0, &second_result);
  }
  else if (return_kind == BX_POLY_RETURN_KIND_FP64 &&
      mode == BX_POLY_MODE_RAW_RISCV) {
    has_second_result = read_poly_riscv_fp64_reg(10, &second_result);
  }
  else if (return_kind == BX_POLY_RETURN_KIND_FP32 &&
      mode == BX_POLY_MODE_RAW_AARCH64) {
    has_fp32_result = read_poly_aarch64_fp32_reg(0, &fp32_result);
  }
  else if (return_kind == BX_POLY_RETURN_KIND_FP32 &&
      mode == BX_POLY_MODE_RAW_RISCV) {
    has_fp32_result = read_poly_riscv_fp32_reg(10, &fp32_result);
  }
  ...
  else if (has_fpair64_result) {
    BX_WRITE_XMM_REG_LO_QWORD(0, fpair64_lo);
    BX_WRITE_XMM_REG_LO_QWORD(1, fpair64_hi);
  }
  ...
  else if (return_kind == BX_POLY_RETURN_KIND_FP32 && has_fp32_result) {
    BX_WRITE_XMM_REG_LO_DWORD(0, fp32_result);
  }
  ...
  bx_address target_rip, bx_address return_rip, Bit32u bridge_kind)
{
  ...
  if (bridge_kind == BX_POLY_CROSS_BRIDGE_VEC128_U32 &&
  ...
  else if (bridge_kind == BX_POLY_CROSS_BRIDGE_FP64) {
    for (Bit32u n = 0; mapped && n < 8; n++) {
      if (callee_mode == BX_POLY_MODE_RAW_AARCH64)
        mapped = write_poly_aarch64_reg(n, args[n]);
      else if (callee_mode == BX_POLY_MODE_RAW_RISCV)
  ...
  else if (bridge_kind == BX_POLY_CROSS_BRIDGE_FP32) {
    for (Bit32u n = 0; mapped && n < 8; n++) {
      if (callee_mode == BX_POLY_MODE_RAW_AARCH64)
        mapped = write_poly_aarch64_reg(n, args[n]);
      else if (callee_mode == BX_POLY_MODE_RAW_RISCV)
    ...
    if (mapped && caller_mode == BX_POLY_MODE_RAW_AARCH64 &&
      ...
      for (Bit32u n = 0; mapped && n < BX_POLY_ABI_BRIDGE_FP_ARG_COUNT; n++) {
        Bit32u fp = 0;
        mapped = read_poly_aarch64_fp32_reg(n, &fp) &&
          write_poly_riscv_fp32_reg(10 + n, fp);
      }
    }
    else if (mapped && caller_mode == BX_POLY_MODE_RAW_RISCV &&
        callee_mode == BX_POLY_MODE_RAW_AARCH64) {
      for (Bit32u n = 0; mapped && n < BX_POLY_ABI_BRIDGE_FP_ARG_COUNT; n++) {
        Bit32u fp = 0;
        mapped = read_poly_riscv_fp32_reg(10 + n, &fp) &&
          write_poly_aarch64_fp32_reg(n, fp);
      }
    }
  }
...
bool BX_CPU_C::return_poly_cross_call(Bit32u callee_mode, bx_address target_rip)
{
  ...
  if (bridge_kind == BX_POLY_CROSS_BRIDGE_DEFAULT) {
    ...
    else if (mapped && callee_mode == BX_POLY_MODE_RAW_AARCH64 &&
...
bool BX_CPU_C::return_poly_import_x86_call(void)
{
  ...
  const bool returns_i128 =
    return_map == BX_POLY_X86_RETURN_MAP_I128;
  const bool returns_fp128 =
    return_map == BX_POLY_X86_RETURN_MAP_FP128;
  const bool returns_fp64 =
    return_map == BX_POLY_X86_RETURN_MAP_FP64;
  const bool returns_fp32 =
    return_map == BX_POLY_X86_RETURN_MAP_FP32;
  const bool returns_fpair64 =
    return_map == BX_POLY_X86_RETURN_MAP_FPAIR64;
  const bool returns_fpair32 =
    return_map == BX_POLY_X86_RETURN_MAP_FPAIR32;
  const bool returns_vec128 =
    return_map == BX_POLY_X86_RETURN_MAP_VEC128;
  const bool returns_compact_u32_f32 =
    return_map == BX_POLY_X86_RETURN_MAP_COMPACT_U32_F32;
  const bool returns_compact_f32_u32 =
    return_map == BX_POLY_X86_RETURN_MAP_COMPACT_F32_U32;
  ...
  bx_poly_aarch64_tls_base = frame.saved_aarch64_tls_base;
  bx_poly_riscv_tls_base = frame.saved_riscv_tls_base;
  ...
  bx_address return_rip, Bit32u source_kind)
{
  ...
  const bool maps_fp64_window_to_x86 =
    ...
    source_kind == BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_FPAIR64_RET ||
    source_kind == BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_FPAIR64_ARG;
  const bool maps_fp32_window_to_x86 =
    source_kind == BX_POLY_ABI_SIGNATURE_KIND_NATIVE_REGS_FP32 ||
    source_kind == BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_FPAIR32_RET;
  ...
  // Direct imports normally run ordinary x86_64 code on x86 TLS. A TLS-aware
  ...
  if (source_kind == BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_FPAIR64_RET)
    frame->return_map = BX_POLY_X86_RETURN_MAP_FPAIR64;
  if (source_kind == BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_FPAIR32_RET)
    frame->return_map = BX_POLY_X86_RETURN_MAP_FPAIR32;
  if (source_kind == BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_FPAIR64_ARG)
    frame->return_map = BX_POLY_X86_RETURN_MAP_FP64;
  if (source_kind == BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_FPAIR32_ARG)
    frame->return_map = BX_POLY_X86_RETURN_MAP_FP32;
  ...
  frame->saved_aarch64_tls_base = bx_poly_aarch64_tls_base;
  frame->saved_riscv_tls_base = bx_poly_riscv_tls_base;
  frame->saved_source_reg2 = args[2];
  ...
  if (maps_fp32_window_to_x86) {
    for (Bit32u n = 0; n < BX_POLY_ABI_BRIDGE_FP_ARG_COUNT; n++) {
      BX_WRITE_XMM_REG_LO_DWORD(n, fp32_args[n]);
      BX_WRITE_XMM_REG_HI_QWORD(n, 0);
    }
  }
  if (maps_fpair32_arg_to_x86) {
    BX_WRITE_XMM_REG_LO_QWORD(0,
      ((Bit64u) fp32_args[1] << 32) | fp32_args[0]);
    BX_WRITE_XMM_REG_HI_QWORD(0, 0);
    BX_WRITE_XMM_REG_LO_DWORD(1, fp32_args[2]);
  ...
  bx_address return_rip)
{
  ...
  if (import_id >= BX_POLY_IMPORT_TRAP_SLOT_COUNT)
    return false;
...
bool BX_CPU_C::execute_poly_raw_aarch64(Bit32u insn, bx_address pc)
{
  ...
  if ((insn & 0xffffffe0) == 0xd51bd040) {
    ...
    if (!read_poly_aarch64_reg(rn, &value))
      return false;
    bx_poly_aarch64_tls_base = (bx_address) value;
    RIP = next_rip;
    BX_DEBUG(("poly_raw: emulated aarch64 msr tpidr_el0,x%u value=%llx",
      rn, (unsigned long long) bx_poly_aarch64_tls_base));
    return true;
  }

  {
    Bit32u aes_op = insn & ~(Bit32u)(0x1f | (0x1f << 5));
    Bit32u rd = insn & 0x1f;
    Bit32u rn = (insn >> 5) & 0x1f;
    const char *op_name = 0;
    bool decrypt = false;
    bool mix_columns = false;
    bool inverse_mix = false;
    ...
    if (op_name != 0) {
      if (mix_columns) {
        if (!read_poly_aarch64_fp128_reg(rn, &src_lo, &src_hi))
          return false;
        bx_poly_aes_mix_vector(src_lo, src_hi, &result_lo, &result_hi,
          inverse_mix);
      }
      else {
        ...
        result_lo = dst_lo;
        result_hi = dst_hi;
        bx_poly_aes_round(&result_lo, &result_hi, src_lo, src_hi, decrypt);
      }
    ...
    if (sm3ss1_op == 0xce400000 || sm3part_op == 0xce60c000 ||
      ...
      if (sm3ss1_op == 0xce400000) {
        ...
        if (!read_poly_aarch64_fp128_reg(rd, &dst_lo, &dst_hi) ||
            !read_poly_aarch64_fp128_reg(rn, &src_lo, &src_hi))
          return false;
        bx_poly_sm4_four_rounds(dst_lo, dst_hi, src_lo, src_hi, false,
          &result_lo, &result_hi);
      }
      else if (sm4ekey_op == 0xce60c800) {
        op_name = "sm4ekey";
        if (!read_poly_aarch64_fp128_reg(rn, &src_lo, &src_hi) ||
            !read_poly_aarch64_fp128_reg(rm, &src2_lo, &src2_hi))
          return false;
        bx_poly_sm4_four_rounds(src_lo, src_hi, src2_lo, src2_hi, true,
          &result_lo, &result_hi);
      }
      else if (sha3_ternary_op == 0xce000000 ||
  ...
  if ((insn & 0xffffffe0) == 0xd5380000 || // midr_el1
      ...
      (insn & 0xffffffe0) == 0xd5380440 || // id_aa64pfr2_el1
      (insn & 0xffffffe0) == 0xd5380480 || // id_aa64zfr0_el1
      (insn & 0xffffffe0) == 0xd53804a0 || // id_aa64smfr0_el1
      (insn & 0xffffffe0) == 0xd5380700 || // id_aa64mmfr0_el1
      (insn & 0xffffffe0) == 0xd5380720 || // id_aa64mmfr1_el1
      (insn & 0xffffffe0) == 0xd5380740 || // id_aa64mmfr2_el1
  ...
  if ((insn & 0xffffffe0) == 0xd53be000 || // cntfrq_el0
    ...
    Bit32u rd = insn & 0x1f;
    Bit64u value = ((insn & 0xffffffe0) == 0xd53be000) ?
      BX_CONST64(1000000000) : bx_pc_system.time_nsec();
    if (!write_poly_aarch64_reg(rd, value))
      return false;
    RIP = next_rip;
    BX_DEBUG(("poly_raw: emulated aarch64 counter mrs x%u,op=%08x value=%llu",
      rd, (unsigned) insn, (unsigned long long) value));
    return true;
  }

  if ((insn & 0xffffffe0) == 0xd50b7520 || // ic ivau,xt
      (insn & 0xffffffe0) == 0xd50b7b20 || // dc cvau,xt
      (insn & 0xffffffe0) == 0xd50b7a20 || // dc cvac,xt
      (insn & 0xffffffe0) == 0xd50b7e20 || // dc civac,xt
      (insn & 0xffffffe0) == 0xd5087620) { // dc ivac,xt
    Bit32u rt = insn & 0x1f;
    Bit64u value = 0;
    if (!read_poly_aarch64_reg(rt, &value))
      return false;
    RIP = next_rip;
    BX_DEBUG(("poly_raw: emulated aarch64 cache maintenance op=%08x x%u addr=%llx as no-op",
      (unsigned) insn, rt, (unsigned long long) value));
    return true;
  }
  ...
  if ((insn & ~(Bit32u)(0x1f | (0x1f << 5) | (0x1f << 10) |
      (0x1f << 16))) == 0x9ba00000) {
    Bit32u rd = insn & 0x1f;
    Bit32u rn = (insn >> 5) & 0x1f;
    Bit32u ra = (insn >> 10) & 0x1f;
    Bit32u rm = (insn >> 16) & 0x1f;
    Bit64u addend = 0, left = 0, right = 0;
    if (!read_poly_aarch64_reg(ra, &addend) ||
        !read_poly_aarch64_reg(rn, &left) ||
        !read_poly_aarch64_reg(rm, &right))
      return false;
    Bit64u result = addend + ((Bit64u) (Bit32u) left * (Bit64u) (Bit32u) right);
    if (!write_poly_aarch64_reg(rd, result))
      return false;
    RIP = next_rip;
    BX_DEBUG(("poly_raw: emulated aarch64 umaddl x%u,w%u,w%u,x%u result=%llu",
      rd, rn, rm, ra, (unsigned long long) result));
    return true;
  }

  if ((insn & ~(Bit32u)(0x1f | (0x1f << 5))) == 0x4c407000 ||
      (insn & ~(Bit32u)(0x1f | (0x1f << 5))) == 0x4c40a000) {
    Bit32u rt = insn & 0x1f;
    Bit32u rn = (insn >> 5) & 0x1f;
    bool two_regs = (insn & ~(Bit32u)(0x1f | (0x1f << 5))) == 0x4c40a000;
    Bit64u base = 0;
    if (rn == 31)
      base = RSP;
    ...
    if (!write_poly_aarch64_fp128_reg(rt, lo, hi))
      return false;
    if (two_regs) {
      lo = read_virtual_qword(BX_SEG_REG_DS, addr + 16);
      hi = read_virtual_qword(BX_SEG_REG_DS, addr + 24);
      if (!write_poly_aarch64_fp128_reg((rt + 1) & 0x1f, lo, hi))
        return false;
    }
    RIP = next_rip;
    BX_DEBUG(("poly_raw: emulated aarch64 ld1 {%u x v.16b},[x%u] addr=%llx",
      two_regs ? 2U : 1U, rn, (unsigned long long) addr));
    return true;
  }

  if ((insn & ~(Bit32u)(0x1f | (0x1f << 5))) == 0x4cdf7000) {
    Bit32u rt = insn & 0x1f;
    Bit32u rn = (insn >> 5) & 0x1f;
    Bit64u base = 0;
    if (rn == 31)
    ...
    if (rn == 31)
      RSP = base + 16;
    else if (!write_poly_aarch64_reg(rn, base + 16))
      return false;
    RIP = next_rip;
    BX_DEBUG(("poly_raw: emulated aarch64 ld1 {v%u.16b},[x%u],#16 addr=%llx",
      rt, rn, (unsigned long long) addr));
    return true;
  }

  if ((insn & ~(Bit32u)(0x1f | (0x1f << 5))) == 0x4e209800) {
    Bit32u rd = insn & 0x1f;
    Bit32u rn = (insn >> 5) & 0x1f;
    ...
    if (!read_poly_aarch64_fp128_reg(rn, &source_lo, &source_hi))
      return false;
    for (Bit32u lane = 0; lane < 16; lane++) {
      Bit64u value = bx_poly_get_vector_element(source_lo, source_hi, 8, lane);
      if (value == 0)
        bx_poly_set_vector_element(&result_lo, &result_hi, 8, lane, 0xff);
    }
    if (!write_poly_aarch64_fp128_reg(rd, result_lo, result_hi))
      return false;
    RIP = next_rip;
    BX_DEBUG(("poly_raw: emulated aarch64 cmeq v%u.16b,v%u.16b,#0",
      rd, rn));
    return true;
  }

  if ((insn & ~(Bit32u)(0x1f | (0x1f << 5) | (0x1f << 16))) == 0x4e20bc00 ||
      (insn & ~(Bit32u)(0x1f | (0x1f << 5) | (0x1f << 16))) == 0x6e20a400) {
    Bit32u rd = insn & 0x1f;
    Bit32u rn = (insn >> 5) & 0x1f;
    Bit32u rm = (insn >> 16) & 0x1f;
    bool maximum = (insn & ~(Bit32u)(0x1f | (0x1f << 5) |
      (0x1f << 16))) == 0x6e20a400;
    Bit64u left_lo = 0, left_hi = 0, right_lo = 0, right_hi = 0;
    Bit64u result_lo = 0, result_hi = 0;
    if (!read_poly_aarch64_fp128_reg(rn, &left_lo, &left_hi) ||
        !read_poly_aarch64_fp128_reg(rm, &right_lo, &right_hi))
      return false;
    for (Bit32u lane = 0; lane < 8; lane++) {
      Bit64u a = bx_poly_get_vector_element(left_lo, left_hi, 8, lane * 2);
      Bit64u b = bx_poly_get_vector_element(left_lo, left_hi, 8, lane * 2 + 1);
      Bit64u value = maximum ? (a > b ? a : b) : ((a + b) & 0xff);
      bx_poly_set_vector_element(&result_lo, &result_hi, 8, lane, value);
    }
    for (Bit32u lane = 0; lane < 8; lane++) {
      Bit64u a = bx_poly_get_vector_element(right_lo, right_hi, 8, lane * 2);
      Bit64u b = bx_poly_get_vector_element(right_lo, right_hi, 8, lane * 2 + 1);
      Bit64u value = maximum ? (a > b ? a : b) : ((a + b) & 0xff);
      bx_poly_set_vector_element(&result_lo, &result_hi, 8, lane + 8, value);
    }
    if (!write_poly_aarch64_fp128_reg(rd, result_lo, result_hi))
      return false;
    RIP = next_rip;
    BX_DEBUG(("poly_raw: emulated aarch64 %s v%u.16b,v%u.16b,v%u.16b",
      maximum ? "umaxp" : "addp", rd, rn, rm));
    return true;
  }

  {
    Bit32u bit_select_base = insn & ~(Bit32u)(0x1f | (0x1f << 5) |
      (0x1f << 16) | 0x40000000);
    const char *op_name = 0;
    Bit32u rd = insn & 0x1f;
    Bit32u rn = (insn >> 5) & 0x1f;
    ...
    if (bit_select_base == 0x2e601c00)
      op_name = "bsl";
    else if (bit_select_base == 0x2ea01c00)
      op_name = "bit";
    else if (bit_select_base == 0x2ee01c00)
      op_name = "bif";

    if (op_name != 0) {
      Bit64u dst_lo = 0, dst_hi = 0;
      Bit64u src_lo = 0, src_hi = 0;
      Bit64u mask_lo = 0, mask_hi = 0;
      Bit64u result_lo = 0, result_hi = 0;

      if (!read_poly_aarch64_fp128_reg(rd, &dst_lo, &dst_hi) ||
          !read_poly_aarch64_fp128_reg(rn, &src_lo, &src_hi) ||
          !read_poly_aarch64_fp128_reg(rm, &mask_lo, &mask_hi))
        return false;

      if (bit_select_base == 0x2e601c00) {
        result_lo = (src_lo & dst_lo) | (mask_lo & ~dst_lo);
        result_hi = (src_hi & dst_hi) | (mask_hi & ~dst_hi);
      }
      else if (bit_select_base == 0x2ea01c00) {
        result_lo = (dst_lo & ~mask_lo) | (src_lo & mask_lo);
        result_hi = (dst_hi & ~mask_hi) | (src_hi & mask_hi);
      }
      else {
        result_lo = (dst_lo & mask_lo) | (src_lo & ~mask_lo);
        result_hi = (dst_hi & mask_hi) | (src_hi & ~mask_hi);
  ...
  if ((insn & ~(Bit32u)(0x1f | (0x1f << 5) | (0x1f << 16))) == 0x6e203c00) {
    Bit32u rd = insn & 0x1f;
    Bit32u rn = (insn >> 5) & 0x1f;
    Bit32u rm = (insn >> 16) & 0x1f;
    Bit64u left_lo = 0, left_hi = 0, right_lo = 0, right_hi = 0;
    ...
    if (!read_poly_aarch64_fp128_reg(rn, &left_lo, &left_hi) ||
      ...
      return false;
    for (Bit32u lane = 0; lane < 16; lane++) {
      Bit64u left = bx_poly_get_vector_element(left_lo, left_hi, 8, lane);
      Bit64u right = bx_poly_get_vector_element(right_lo, right_hi, 8, lane);
      if (left >= right)
        bx_poly_set_vector_element(&result_lo, &result_hi, 8, lane, 0xff);
    }
    if (!write_poly_aarch64_fp128_reg(rd, result_lo, result_hi))
      return false;
    RIP = next_rip;
    BX_DEBUG(("poly_raw: emulated aarch64 cmhs v%u.16b,v%u.16b,v%u.16b",
      rd, rn, rm));
    return true;
  }

  if ((insn & ~(Bit32u)(0x1f | (0x1f << 5))) == 0x0f0c8400) {
    Bit32u rd = insn & 0x1f;
    Bit32u rn = (insn >> 5) & 0x1f;
    Bit64u source_lo = 0, source_hi = 0;
    Bit64u result_lo = 0, result_hi = 0;
    if (!read_poly_aarch64_fp128_reg(rn, &source_lo, &source_hi))
      return false;
    for (Bit32u lane = 0; lane < 8; lane++) {
      Bit64u value = bx_poly_get_vector_element(source_lo, source_hi, 16, lane);
      bx_poly_set_vector_element(&result_lo, &result_hi, 8, lane,
        (value >> 4) & 0xff);
    }
    if (!write_poly_aarch64_fp128_reg(rd, result_lo, result_hi))
      return false;
    RIP = next_rip;
    BX_DEBUG(("poly_raw: emulated aarch64 shrn v%u.8b,v%u.8h,#4",
      rd, rn));
    return true;
  }
  ...
  {
    Bit32u pair_exclusive_op = insn & 0x3fe00000;
    Bit32u size_code = (insn >> 30) & 0x3;
    if ((pair_exclusive_op == 0x08600000 ||
         pair_exclusive_op == 0x08200000) &&
        (size_code == 0x2 || size_code == 0x3)) {
      Bit32u rt = insn & 0x1f;
      Bit32u rn = (insn >> 5) & 0x1f;
      Bit32u rt2 = (insn >> 10) & 0x1f;
      Bit32u rs = (insn >> 16) & 0x1f;
      Bit32u op21 = (insn >> 21) & 0x7;
      bool is_load = op21 == 0x3;
      bool is_store = op21 == 0x1;
      bool acquire_release = (insn & 0x00008000) != 0;
      Bit32u element_size = 0;
      Bit64u base = 0;
      ...
      bx_address addr = (bx_address) base;
      Bit32u reservation_size = element_size * 2;
      ...
      if (is_load) {
        ...
        bx_poly_aarch64_reservation_valid = true;
        bx_poly_aarch64_reservation_addr = addr;
        bx_poly_aarch64_reservation_size = reservation_size;
        if (!write_poly_aarch64_reg(rt, element_size == 4 ? (Bit32u) value0 : value0) ||
            !write_poly_aarch64_reg(rt2, element_size == 4 ? (Bit32u) value1 : value1))
          return false;
        RIP = next_rip;
        BX_DEBUG(("poly_raw: emulated aarch64 %s %c%u,%c%u,[rn=%u] addr=%llx value=%llu:%llu",
          acquire_release ? "ldaxp" : "ldxp",
          element_size == 8 ? 'x' : 'w', rt,
          element_size == 8 ? 'x' : 'w', rt2, rn,
          (unsigned long long) addr, (unsigned long long) value0,
      ...
      if (success) {
        ...
        bx_poly_invalidate_reservations_for_store(addr, reservation_size);
      }
      bx_poly_aarch64_reservation_valid = false;
      bx_poly_aarch64_reservation_addr = 0;
      bx_poly_aarch64_reservation_size = 0;
      if (!write_poly_aarch64_reg(rs, success ? 0 : 1))
        return false;
      RIP = next_rip;
      BX_DEBUG(("poly_raw: emulated aarch64 %s w%u,%c%u,%c%u,[rn=%u] addr=%llx %s",
        acquire_release ? "stlxp" : "stxp", rs,
        element_size == 8 ? 'x' : 'w', rt,
        element_size == 8 ? 'x' : 'w', rt2, rn,
  ...
  if ((insn & 0xbfa07c00) == 0x08207c00) {
    ...
    Bit32u size = 0;
    Bit64u base = 0;
    Bit64u expected0 = 0, expected1 = 0;
    Bit64u desired0 = 0, desired1 = 0;
    Bit64u old0 = 0, old1 = 0;
    bool success = false;
    ...
    if (rn == 31)
      ...
      return false;
    if (!read_poly_aarch64_reg(rs, &expected0) ||
        !read_poly_aarch64_reg(rs + 1, &expected1) ||
        !read_poly_aarch64_reg(rt, &desired0) ||
        !read_poly_aarch64_reg(rt + 1, &desired1))
      return false;

    bx_address addr = (bx_address) base;
    if (size == 4) {
      expected0 = (Bit32u) expected0;
      expected1 = (Bit32u) expected1;
      desired0 = (Bit32u) desired0;
      desired1 = (Bit32u) desired1;
      old0 = read_virtual_dword(BX_SEG_REG_DS, addr);
      old1 = read_virtual_dword(BX_SEG_REG_DS, addr + 4);
      success = old0 == expected0 && old1 == expected1;
      if (success) {
        write_virtual_dword(BX_SEG_REG_DS, addr, (Bit32u) desired0);
        write_virtual_dword(BX_SEG_REG_DS, addr + 4, (Bit32u) desired1);
        bx_poly_invalidate_reservations_for_store(addr, 8);
      }
      if (!write_poly_aarch64_reg(rs, (Bit32u) old0) ||
          !write_poly_aarch64_reg(rs + 1, (Bit32u) old1))
        return false;
    }
    else {
      old0 = read_virtual_qword(BX_SEG_REG_DS, addr);
      old1 = read_virtual_qword(BX_SEG_REG_DS, addr + 8);
      success = old0 == expected0 && old1 == expected1;
      if (success) {
        write_virtual_qword(BX_SEG_REG_DS, addr, desired0);
        write_virtual_qword(BX_SEG_REG_DS, addr + 8, desired1);
        bx_poly_invalidate_reservations_for_store(addr, 16);
      }
      if (!write_poly_aarch64_reg(rs, old0) ||
          !write_poly_aarch64_reg(rs + 1, old1))
        return false;
    }

    RIP = next_rip;
    BX_DEBUG(("poly_raw: emulated aarch64 lse casp %c%u,%c%u,%c%u,%c%u,[rn=%u] addr=%llx old=%llu:%llu desired=%llu:%llu %s",
      size == 8 ? 'x' : 'w', rs, size == 8 ? 'x' : 'w', rs + 1,
      size == 8 ? 'x' : 'w', rt, size == 8 ? 'x' : 'w', rt + 1, rn,
      (unsigned long long) addr, (unsigned long long) old0,
      (unsigned long long) old1, (unsigned long long) desired0,
      (unsigned long long) desired1, success ? "success" : "fail"));
    return true;
  }
...

  {
    ...
    if (simd_unary_base == 0x2e20b800) {
      op_name = "neg";
      negate = true;
    }
    else if (simd_unary_base == 0x0e20b800) {
      op_name = "abs";
      absolute = true;
    }
      ...
      for (Bit32u lane = 0; lane < lanes; lane++) {
        ...
        if (negate)
          value = (~source + 1) & mask;
            ...
            bx_poly_sign_extend64(source, element_bits) < 0)
          value = (~source + 1) & mask;
  ...
  {
    Bit32u simd_compare_zero_base = insn & ~(Bit32u)(0x1f | (0x1f << 5) |
      (0x3 << 22) | 0x40000000);
    const char *op_name = 0;
    Bit32u rd = insn & 0x1f;
    Bit32u rn = (insn >> 5) & 0x1f;
    ...
    if (simd_compare_zero_base == 0x0e208800) {
      op_name = "cmgt";
      greater = true;
    }
    else if (simd_compare_zero_base == 0x2e208800) {
      op_name = "cmge";
      greater_equal = true;
    }
    else if (simd_compare_zero_base == 0x0e209800) {
      op_name = "cmeq";
      equal = true;
    }
    else if (simd_compare_zero_base == 0x2e209800) {
      op_name = "cmle";
      less_equal = true;
    }
    else if (simd_compare_zero_base == 0x0e20a800) {
      op_name = "cmlt";
      less = true;
    }
    ...
    if (op_name != 0) {
      ...
      if (!write_poly_aarch64_fp128_reg(rd, result_lo, result_hi))
        return false;
      RIP = next_rip;
      BX_DEBUG(("poly_raw: emulated aarch64 %s v%u.%u-bit,v%u,#0 lo=%llu hi=%llu",
        op_name, rd, element_bits, rn,
        (unsigned long long) result_lo, (unsigned long long) result_hi));
      return true;
    }
  ...
  {
    Bit32u simd_minmax_base = insn & ~(Bit32u)(0x1f | (0x1f << 5) |
      (0x1f << 16) | (0x3 << 22) | 0x40000000);
    const char *op_name = 0;
    Bit32u rd = insn & 0x1f;
    Bit32u rn = (insn >> 5) & 0x1f;
    Bit32u rm = (insn >> 16) & 0x1f;
    ...
    if (simd_minmax_base == 0x0e206400) {
      op_name = "smax";
    }
    else if (simd_minmax_base == 0x0e206c00) {
      op_name = "smin";
      minimum = true;
    }
    else if (simd_minmax_base == 0x2e206400) {
      op_name = "umax";
      is_unsigned = true;
    }
    else if (simd_minmax_base == 0x2e206c00) {
      op_name = "umin";
      is_unsigned = true;
      minimum = true;
    }
    ...
    if (op_name != 0) {
      ...
      for (Bit32u lane = 0; lane < lanes; lane++) {
        Bit64u left = bx_poly_get_vector_element(left_lo, left_hi,
          element_bits, lane);
        Bit64u right = bx_poly_get_vector_element(right_lo, right_hi,
          element_bits, lane);
        Bit64u value = 0;
        if (is_unsigned) {
          bool take_left = minimum ? left <= right : left >= right;
          value = take_left ? left : right;
        }
        else {
          Bit64s signed_left = bx_poly_sign_extend64(left, element_bits);
          Bit64s signed_right = bx_poly_sign_extend64(right, element_bits);
          bool take_left = minimum ? signed_left <= signed_right :
  ...
  {
    Bit32u simd_absdiff_base = insn & ~(Bit32u)(0x1f | (0x1f << 5) |
      (0x1f << 16) | (0x3 << 22) | 0x40000000);
    const char *op_name = 0;
    Bit32u rd = insn & 0x1f;
    Bit32u rn = (insn >> 5) & 0x1f;
    ...
    if (simd_absdiff_base == 0x0e207400) {
      op_name = "sabd";
    }
    else if (simd_absdiff_base == 0x2e207400) {
      op_name = "uabd";
      is_unsigned = true;
    }
    else if (simd_absdiff_base == 0x0e207c00) {
      op_name = "saba";
      accumulate = true;
    }
    else if (simd_absdiff_base == 0x2e207c00) {
      op_name = "uaba";
      is_unsigned = true;
      accumulate = true;
    }
    ...
    if (op_name != 0) {
      ...
      if (!read_poly_aarch64_fp128_reg(rn, &left_lo, &left_hi) ||
          !read_poly_aarch64_fp128_reg(rm, &right_lo, &right_hi))
        return false;
      if (accumulate && !read_poly_aarch64_fp128_reg(rd, &dst_lo, &dst_hi))
        return false;
      ...
      for (Bit32u lane = 0; lane < lanes; lane++) {
        ...
        if (is_unsigned) {
          ...
          Bit64s signed_left = bx_poly_sign_extend64(left, element_bits);
          Bit64s signed_right = bx_poly_sign_extend64(right, element_bits);
          Bit64s signed_diff = signed_left - signed_right;
          diff = (Bit64u) (signed_diff < 0 ? -signed_diff : signed_diff);
        }
        if (accumulate) {
          Bit64u acc = bx_poly_get_vector_element(dst_lo, dst_hi,
            element_bits, lane);
          diff = (acc + diff) & mask;
        }
        bx_poly_set_vector_element(&result_lo, &result_hi, element_bits,
  ...
  {
    Bit32u simd_long_shift_base = insn & ~(Bit32u)(0x1f | (0x1f << 5) |
      (0xf << 19) | (0x7 << 16) | 0x40000000);
    const char *op_name = 0;
    Bit32u rd = insn & 0x1f;
    Bit32u rn = (insn >> 5) & 0x1f;
    Bit32u immh = (insn >> 19) & 0xf;
    Bit32u immb = (insn >> 16) & 0x7;
    bool high_half = (insn & 0x40000000) != 0;
    bool is_unsigned = false;
    Bit64u source_lo = 0, source_hi = 0;
    Bit64u result_lo = 0, result_hi = 0;

    if (simd_long_shift_base == 0x0f00a400) {
      op_name = high_half ? "sshll2" : "sshll";
    }
    else if (simd_long_shift_base == 0x2f00a400) {
      op_name = high_half ? "ushll2" : "ushll";
      is_unsigned = true;
    }
    ...
    if (op_name != 0) {
      ...
      Bit32u shift = ((immh << 3) | immb) - source_bits;
      if (shift >= source_bits)
        return false;

      Bit32u dest_bits = source_bits * 2;
      Bit32u lanes = 64 / source_bits;
      Bit32u source_lane_base = high_half ? lanes : 0;
      Bit64u dest_mask = bx_poly_low_mask(dest_bits);
      ...
      for (Bit32u lane = 0; lane < lanes; lane++) {
        Bit64u source = bx_poly_get_vector_element(source_lo, source_hi,
          source_bits, source_lane_base + lane);
        Bit64u value = is_unsigned ? source :
          (Bit64u) bx_poly_sign_extend64(source, source_bits);
        value = (value << shift) & dest_mask;
        bx_poly_set_vector_element(&result_lo, &result_hi, dest_bits,
          lane, value);
      }
  ...
  {
    Bit32u simd_long_addsub_base = insn & ~(Bit32u)(0x1f | (0x1f << 5) |
      (0x1f << 16) | (0x3 << 22) | 0x40000000);
    const char *op_name = 0;
    Bit32u rd = insn & 0x1f;
    Bit32u rn = (insn >> 5) & 0x1f;
    ...
    if (simd_long_addsub_base == 0x0e200000) {
      op_name = high_half ? "saddl2" : "saddl";
    }
    else if (simd_long_addsub_base == 0x2e200000) {
      op_name = high_half ? "uaddl2" : "uaddl";
      is_unsigned = true;
    }
    else if (simd_long_addsub_base == 0x0e202000) {
      op_name = high_half ? "ssubl2" : "ssubl";
      subtract = true;
    }
    else if (simd_long_addsub_base == 0x2e202000) {
      op_name = high_half ? "usubl2" : "usubl";
      is_unsigned = true;
      subtract = true;
    }
    ...
    if (op_name != 0) {
      ...
      for (Bit32u lane = 0; lane < lanes; lane++) {
        ...
        if (is_unsigned) {
          ...
          Bit64s signed_left = bx_poly_sign_extend64(left, source_bits);
          Bit64s signed_right = bx_poly_sign_extend64(right, source_bits);
          Bit64s signed_value = subtract ? signed_left - signed_right :
            signed_left + signed_right;
          value = (Bit64u) signed_value;
        }

        bx_poly_set_vector_element(&result_lo, &result_hi, dest_bits,
          lane, value & dest_mask);
      }
  ...
  {
    Bit32u simd_mul_base = insn & ~(Bit32u)(0x1f | (0x1f << 5) |
      (0x1f << 16) | (0x3 << 22) | 0x40000000);
    const char *op_name = 0;
    Bit32u rd = insn & 0x1f;
    Bit32u rn = (insn >> 5) & 0x1f;
    ...
    if (simd_mul_base == 0x0e209c00) {
      op_name = "mul";
    }
    else if (simd_mul_base == 0x0e209400) {
      op_name = "mla";
      accumulate = true;
    }
    else if (simd_mul_base == 0x2e209400) {
      op_name = "mls";
      accumulate = true;
      subtract = true;
    }
    ...
    if (op_name != 0) {
      ...
      if (!read_poly_aarch64_fp128_reg(rn, &left_lo, &left_hi) ||
          !read_poly_aarch64_fp128_reg(rm, &right_lo, &right_hi))
        return false;
      if (accumulate && !read_poly_aarch64_fp128_reg(rd, &dest_lo, &dest_hi))
        return false;
      ...
      for (Bit32u lane = 0; lane < lanes; lane++) {
        ...
        Bit64u right = bx_poly_get_vector_element(right_lo, right_hi,
          element_bits, lane);
        Bit64u value = (left * right) & mask;
        if (accumulate) {
          Bit64u dest = bx_poly_get_vector_element(dest_lo, dest_hi,
            element_bits, lane);
          value = (subtract ? dest - value : dest + value) & mask;
        }
        bx_poly_set_vector_element(&result_lo, &result_hi, element_bits,
          lane, value);
      }
  ...
  if (insn == BX_POLY_AARCH64_CTRL_TRAP_VECTOR_MODE_SET) {
    ...
    if (!read_poly_aarch64_reg(0, &mode))
      return false;
    if (!bx_poly_u32_from_u64(mode, &mode_id) ||
        !bx_poly_valid_frontend_mode(mode_id)) {
      write_poly_aarch64_reg(0, (Bit64u) (Bit64s) -22);
      RIP = next_rip;
      return true;
    }
    if (!bx_poly_valid_trap_vector_target(bx_poly_trap_vector,
          mode_id, BX_CPU_THIS_PTR linaddr_width)) {
      write_poly_aarch64_reg(0, (Bit64u) (Bit64s) -22);
      RIP = next_rip;
      return true;
    }
    bx_poly_trap_vector_mode = mode_id;
    bx_address stack_key = bx_poly_current_state_key(RSP);
    bx_poly_commit_reg_state(BX_CPU_THIS_PTR cr3, MSR_FSBASE, stack_key);
    bx_poly_propagate_trap_vector_state(BX_CPU_THIS_PTR cr3, MSR_FSBASE,
      stack_key);
  ...
  if (insn == BX_POLY_AARCH64_CTRL_ABI_SIGNATURE_SET) {
    ...
    if (!read_poly_aarch64_reg(0, &slot) ||
        !read_poly_aarch64_reg(1, &value))
      return false;
    if (!bx_poly_u32_from_u64(slot, &slot_id) ||
        slot_id >= BX_POLY_ABI_SIGNATURE_SLOT_COUNT ||
        !bx_poly_decode_abi_signature_value(value, &kind)) {
      write_poly_aarch64_reg(0, (Bit64u) (Bit64s) -22);
      RIP = next_rip;
      return true;
    }
    ...
    bx_poly_commit_reg_state(BX_CPU_THIS_PTR cr3, MSR_FSBASE,
      bx_poly_current_state_key(RSP));
    RIP = next_rip;
    BX_DEBUG(("poly_raw: aarch64 ABI signature set slot=%llu kind=%u",
      (unsigned long long) slot, kind));
    return true;
  }
  ...
  if ((insn & 0x3b200000) == 0x38000000) {
    ...
    if (fp) {
      const bool is_q = size == 0 && (opc == 2 || opc == 3);
      if (size < 2 && !is_q)
        return false;
      if (opc == 1) {
        if (size == 2) {
      ...
      if (is_q && opc == 3) {
        ...
        RIP = next_rip;
        BX_DEBUG(("poly_raw: emulated aarch64 fp ldr128%s v%u,[x%u,#%lld] addr=%llx",
          (pre_index || post_index) ? "-wb" : "ur",
          rt, rn, (long long) offset, (unsigned long long) addr));
        return true;
      }
      if (opc != 0 && !(is_q && opc == 2))
      ...
      BX_DEBUG(("poly_raw: emulated aarch64 fp str%u%s v%u,[x%u,#%lld] addr=%llx",
        is_q ? 128U : (8U << size), (pre_index || post_index) ? "-wb" : "ur",
        rt, rn, (long long) offset, (unsigned long long) addr));
      return true;
    }
...
bool BX_CPU_C::execute_poly_raw_riscv(Bit32u insn, bx_address pc)
{
  ...
  if (insn == BX_POLY_RISCV_CTRL_ABI_SIGNATURE_SET) {
    ...
    bx_poly_commit_reg_state(BX_CPU_THIS_PTR cr3, MSR_FSBASE,
      bx_poly_current_state_key(RSP));
    RIP = next_rip;
    BX_DEBUG(("poly_raw: riscv ABI signature set slot=%llu kind=%u",
      (unsigned long long) slot, kind));
    return true;
  }
  ...
  if ((insn & 0x0000007f) == 0x00000073) {
    ...
    if ((csr == 0xc00 || csr == 0xc01 || csr == 0xc02 ||
      ...
      if ((funct3 == 0x2 || funct3 == 0x3) && rs1 == 0)
        read_only = true;
      if ((funct3 == 0x6 || funct3 == 0x7) && rs1 == 0)
        read_only = true;
      if (!read_only)
        return false;
      ...
      if (!write_poly_riscv_reg(rd, value))
        return false;
      RIP = next_rip;
      BX_DEBUG(("poly_raw: emulated riscv counter csr=%03x rd=x%u value=%llu",
        csr, rd, (unsigned long long) value));
      return true;
    }
...
bool BX_CPP_AttrRegparmN(1) BX_CPU_C::handle_poly_opcode(bxInstruction_c *i)
{
  ...
  if (opcode0 == 0x0f && opcode1 == 0x3a && opcode2 == 0xfc) {
    ...
    bx_address next_rip = PREV_RIP + 4;
      ...
      if (op >= 0x14 && op <= 0x1d) {
        BX_INFO(("poly_ud: reject shape-specific pcall opcode=0x%02x; use signature PCALL with an ABI slot",
          op));
        return false;
      }
      if (op == 0x21 || op == 0x22) {
...
void BX_CPP_AttrRegparmN(1) BX_CPU_C::CPUID(bxInstruction_c *i)
{
  ...
  if (BX_CPU_THIS_PTR poly_feature_enabled && EAX == BX_POLY_CPUID_BASE + 1) {
    Bit32u feature_mask =
          ...
          BX_POLY_CPUID_FEATURE_PER_THREAD_STATE |
          ...
          BX_POLY_CPUID_FEATURE_AARCH64_HFA32_ARGS |
  ...
  if (BX_CPU_THIS_PTR poly_feature_enabled && EAX == BX_POLY_CPUID_BASE + 2) {
    if (ECX == 0) {
      ...
      RDX = BX_POLY_X86_CTRL_TRAP_RETURN;
    }
    else if (ECX == 6) {
      ...
      RAX = BX_POLY_X86_CTRL_PCALL_SIG_IMM_BASE;
      ...
      RCX = BX_POLY_ABI_SIGNATURE_SLOT_COUNT;
      RDX = BX_POLY_X86_CTRL_PCALL_SIG_IMM_BASE;
    }
    else if (ECX == 12) {
      ...
      RAX = BX_POLY_ABI_REGISTER_MAP_EXCHANGE |
        (BX_POLY_ABI_REGISTER_MAP_X86_SYSV_TO_NATIVE << 8) |
        (BX_POLY_ABI_REGISTER_MAP_X86_SYSV_TO_NATIVE_I128 << 16) |
        (BX_POLY_ABI_REGISTER_MAP_NATIVE << 24);
      RBX = BX_POLY_ABI_REGISTER_MAP_NATIVE_I128 |
        (BX_POLY_ABI_REGISTER_MAP_NATIVE_VEC128_U32 << 8) |
        (BX_POLY_ABI_REGISTER_MAP_NATIVE_COMPACT_U32_F32 << 16) |
        (BX_POLY_ABI_REGISTER_MAP_NATIVE_COMPACT_F32_U32 << 24);
      ...
      RAX = BX_POLY_ABI_SIGNATURE_SLOT_NATIVE_REGS_COMPACT_U32_F32;
      RBX = BX_POLY_ABI_SIGNATURE_KIND_NATIVE_REGS_COMPACT_U32_F32;
      RCX = BX_POLY_ABI_SIGNATURE_SLOT_NATIVE_REGS_COMPACT_F32_U32;
      RDX = BX_POLY_ABI_SIGNATURE_KIND_NATIVE_REGS_COMPACT_F32_U32;
    }
    else if (ECX == 21) {
      RAX = BX_POLY_STATE_XSAVE_STATE_KEY_OFFSET;
      RBX = BX_POLY_STATE_XSAVE_STATE_KEY_BYTES;
      ...
      RAX = BX_POLY_ABI_SIGNATURE_SLOT_SRET_X86_SYSV_REGS;
      RBX = BX_POLY_ABI_SIGNATURE_KIND_SRET_X86_SYSV_REGS;
      RCX = BX_POLY_ABI_REGISTER_MAP_SRET_X86_SYSV_TO_NATIVE;
      RDX = BX_POLY_ABI_BRIDGE_GPR_ARG_COUNT;
    }
    else if (ECX == 25) {
      RAX = BX_POLY_ABI_SIGNATURE_SLOT_X86_SYSV_REGS_FP128_RET;
      RBX = BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_FP128_RET;
      RCX = BX_POLY_ABI_REGISTER_MAP_X86_SYSV_TO_NATIVE_FP128_RET;
      RDX = BX_POLY_ABI_BRIDGE_GPR_ARG_COUNT;
    }
    else if (ECX == 26) {
      RAX = BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_AARCH64_HFA3_F32_RET;
      ...
      RAX = BX_POLY_ABI_SIGNATURE_KIND_X86_SYSV_REGS_AARCH64_HFA3_F64_RET;
  ...
  if (BX_CPU_THIS_PTR poly_feature_enabled && EAX == BX_POLY_CPUID_BASE + 4) {
    if (ECX == 0) {
      ...
      RAX = BX_POLY_STATE_XSAVE_HEADER_OFFSET;
      RBX = BX_POLY_STATE_XSAVE_HEADER_BYTES;
      RCX = BX_POLY_STATE_XSAVE_MAGIC;
      ...
      RBX = BX_POLY_STATE_XSAVE_AARCH64_GPR_BYTES;
      RCX = 32;
      RDX = 8;
    }
    else if (ECX == 4) {
      RAX = BX_POLY_STATE_XSAVE_AARCH64_FP_OFFSET;
      RBX = BX_POLY_STATE_XSAVE_AARCH64_FP_BYTES;
      RCX = 32;
      RDX = 16;
    }
    else if (ECX == 5) {
      RAX = BX_POLY_STATE_XSAVE_AARCH64_STATUS_OFFSET;
      RBX = BX_POLY_STATE_XSAVE_AARCH64_STATUS_BYTES;
      RCX = BX_POLY_STATE_XSAVE_AARCH64_STATUS_BYTES;
      RDX = 0;
    }
    else if (ECX == 6) {
      RAX = BX_POLY_STATE_XSAVE_RISCV_GPR_OFFSET;
      RBX = BX_POLY_STATE_XSAVE_RISCV_GPR_BYTES;
      RCX = 32;
      RDX = 8;
    }
    else if (ECX == 7) {
      RAX = BX_POLY_STATE_XSAVE_RISCV_FP_OFFSET;
      RBX = BX_POLY_STATE_XSAVE_RISCV_FP_BYTES;
      RCX = 32;
      RDX = 16;
    }
    else if (ECX == 8) {
      RAX = BX_POLY_STATE_XSAVE_RISCV_STATUS_OFFSET;
      RBX = BX_POLY_STATE_XSAVE_RISCV_STATUS_BYTES;
      RCX = BX_POLY_STATE_XSAVE_RISCV_STATUS_BYTES;
      RDX = 0;
    }
    else if (ECX == 9) {
      RAX = BX_POLY_STATE_XSAVE_ABI_SIGNATURE_OFFSET;
      RBX = BX_POLY_STATE_XSAVE_ABI_SIGNATURE_BYTES;
      RCX = BX_POLY_ABI_SIGNATURE_SLOT_COUNT;
      RDX = 8;
    }
    else if (ECX == 10) {
      RAX = BX_POLY_STATE_XSAVE_FRONTEND_TLS_OFFSET;
      RBX = BX_POLY_STATE_XSAVE_FRONTEND_TLS_BYTES;
      RCX = BX_POLY_STATE_XSAVE_FRONTEND_TLS_BYTES;
      RDX = 0;
    }
    else if (ECX == 11) {
      RAX = BX_POLY_STATE_XSAVE_LANDING_POLICY_OFFSET;
      RBX = BX_POLY_STATE_XSAVE_LANDING_POLICY_BYTES;
      RCX = (Bit32u) BX_POLY_LANDING_POLICY_SUPPORTED;
      RDX = 0;
    }
    else if (ECX == 12) {
      ...
      RAX = BX_POLY_STATE_XSAVE_TRAP_RESTORE_OFFSET;
      RBX = BX_POLY_STATE_XSAVE_TRAP_RESTORE_BYTES;
      RCX = (Bit32u) BX_POLY_TRAP_RESTORE_FLAGS_SUPPORTED;
      RDX = 0;
    }
    else if (ECX == 14) {
  ...
  if (BX_CPU_THIS_PTR poly_feature_enabled && EAX == BX_POLY_CPUID_BASE + 8) {
    if (ECX == 0) {
      ...
      RAX = BX_POLY_STATE_XSAVE_TRANSITION_OFFSET;
      RBX = BX_POLY_STATE_XSAVE_TRANSITION_BYTES;
      RCX = BX_POLY_TRANSITION_FRAME_BYTES;
      RDX = 0;
    }
    else if (ECX == 3) {
  ...
  if (BX_CPU_THIS_PTR poly_feature_enabled && EAX == BX_POLY_CPUID_BASE + 9) {
    ...
    RBX = BX_POLY_ABI_BRIDGE_FLAG_X86_SYSV_TO_AAPCS64 |
          ...
          BX_POLY_ABI_BRIDGE_FLAG_REGISTER_ONLY_AGGREGATES |
          ...
          BX_POLY_ABI_BRIDGE_FLAG_REGISTER_MAP_SIGNATURES;
