...
static const Bit32u BX_POLY_ABI_BRIDGE_FLAG_RESERVED_DESCRIPTOR_IMPORTS = (1U << 6);
static const Bit32u BX_POLY_ABI_BRIDGE_FLAG_TLS_BASE = (1U << 7);
static const Bit32u BX_POLY_ABI_BRIDGE_FLAG_RESERVED_USER_DESCRIPTORS = (1U << 8);
