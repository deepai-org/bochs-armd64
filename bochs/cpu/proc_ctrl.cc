...
static const Bit32u BX_POLY_CPUID_MAX = 0x40000005;
...
static inline bool bx_poly_import_requires_software_descriptor(Bit64u import_id)
{
  switch (import_id) {
    ...
    case BX_POLY_IMPORT_FUNC_FIXDFTI:
    case BX_POLY_IMPORT_FUNC_FIXUNSDFTI:
    case BX_POLY_IMPORT_FUNC_FLOATTIDF:
    case BX_POLY_IMPORT_FUNC_FLOATUNTIDF:
    case BX_POLY_IMPORT_FUNC_FIXSFTI:
  ...
  bx_address return_rip)
{
  ...
  // Software-supplied import descriptors override fixed helpers only for
  // imports whose ABI contract is descriptor-backed.
  // This keeps symbol policy in the guest runtime: the CPU only provides the
  // cross-frontend call gate when a concrete target descriptor is present.
  if (R12 != 0 &&
      (bx_poly_import_requires_software_descriptor(import_id) ||
       bx_poly_import_is_x86_descriptor(import_id))) {
    Bit64u arg0 = 0, arg1 = 0, arg2 = 0, arg3 = 0;
    Bit64u arg4 = 0, arg5 = 0, arg6 = 0, arg7 = 0;
    bool mapped = false;
    if (mode == BX_POLY_MODE_RAW_AARCH64) {
    ...
    if (target != 0 && trampoline != 0) {
      ...
      BX_INFO(("poly_raw: import descriptor override mode=%u descriptor=%u target=%llx trampoline=%llx stack=%llx arg0=%llu arg1=%llu arg2=%llu arg3=%llu arg4=%llu arg5=%llu arg6=%llu arg7=%llu return=%llx",
